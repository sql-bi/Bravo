...
public class BootstrapContextTests
{
    ...
    [Fact]
    public void Create_SettingsCreationFailureUsesDefaultsCreatesTelemetryAndLogsError()
    {
        ...
        Assert.IsType<UserSettings>(context.Settings);
        Assert.Equal(UserSettings.DefaultTelemetryEnabled, context.Settings.TelemetryEnabled);
        Assert.Equal([UserSettings.DefaultTelemetryEnabled], telemetryFactory.EnabledValues);
        Assert.Equal(UserSettings.DefaultTelemetryEnabled, context.Telemetry.TelemetryEnabled);
    ...
    [Fact]
    public void Create_TelemetryFailureUsesDisabledServiceAndLogsError()
    {
    ...
    private sealed class FakePolicyFactory(Func<IPolicyService> create) : IPolicyServiceFactory
    {
