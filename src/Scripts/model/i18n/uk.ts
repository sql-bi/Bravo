...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Обфусковано",
        [_.docObfuscatedTooltip]: "Цей документ було завантажено з обфускованого файлу VPAX. Натисніть, щоб деобфускувати його.",
        [_.deobfuscateDialogTitle]: "Деобфускувати VPAX",
        [_.deobfuscateDialogDragFile]: "Перетягніть сюди файл словника VPAX<br>або знайдіть його на своєму комп'ютері",
        [_.deobfuscateDialogNote]: "Файл словника (.dict) необхідний для деобфускування файлу VPAX. Він використовується виключно з цією метою і ніколи не передається, не зберігається та не надсилається за межі цього застосунку.",
