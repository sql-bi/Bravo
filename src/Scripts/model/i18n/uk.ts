...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.manageCalendarsTableLabel]: "Таблиця:",
        [_.manageCalendarsAddCalendar]: "Додати календар",
        [_.manageCalendarsTitle]: "Календарі",
        [_.manageCalendarsColumnMapping]: "Зіставлення стовпців",
        [_.manageCalendarsLoadError]: "Помилка завантаження календарів таблиці",
        [_.manageCalendarsNoCalendars]: "Для цієї таблиці не визначено жодного календаря",
        [_.manageCalendarsDeleteButton]: "Видалити",
        [_.manageCalendarsColumnName]: "Стовпець",
        [_.manageCalendarsSampleValues]: "Зразки значень",
        [_.manageCalendarsBlank]: "(порожньо)",
        [_.manageCalendarsUnassigned]: "Не призначено",
        [_.manageCalendarsDate]: "Дата",
        [_.manageCalendarsYear]: "Рік",
        [_.manageCalendarsSemester]: "Семестр",
        [_.manageCalendarsSemesterOfYear]: "Семестр року",
        [_.manageCalendarsQuarter]: "Квартал",
        [_.manageCalendarsQuarterOfYear]: "Квартал року",
        [_.manageCalendarsQuarterOfSemester]: "Квартал семестру",
        [_.manageCalendarsMonth]: "Місяць",
        [_.manageCalendarsMonthOfYear]: "Місяць року",
        [_.manageCalendarsMonthOfSemester]: "Місяць семестру",
        [_.manageCalendarsMonthOfQuarter]: "Місяць кварталу",
        [_.manageCalendarsWeek]: "Тиждень",
        [_.manageCalendarsWeekOfYear]: "Тиждень року",
        [_.manageCalendarsWeekOfSemester]: "Тиждень семестру",
        [_.manageCalendarsWeekOfQuarter]: "Тиждень кварталу",
        [_.manageCalendarsWeekOfMonth]: "Тиждень місяця",
        [_.manageCalendarsDayOfYear]: "День року",
        [_.manageCalendarsDayOfSemester]: "День семестру",
        [_.manageCalendarsDayOfQuarter]: "День кварталу",
        [_.manageCalendarsDayOfMonth]: "День місяця",
        [_.manageCalendarsDayOfWeek]: "День тижня",
        [_.manageCalendarsTimeRelated]: "Пов'язане з часом",
        [_.manageCalendarsUpdateSuccess]: "Календар успішно оновлено",
        [_.manageCalendarsUpdateError]: "Помилка оновлення календаря",
        [_.manageCalendarsEnterName]: "Введіть назву календаря:",
        [_.manageCalendarsCreateSuccess]: "Календар успішно створено",
        [_.manageCalendarsCreateError]: "Помилка створення календаря",
        [_.manageCalendarsConfirmDelete]: "Ви впевнені, що хочете видалити календар '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Календар успішно видалено",
        [_.manageCalendarsDeleteError]: "Помилка видалення календаря",
        [_.manageCalendarsRenameCalendar]: "Перейменувати",
        [_.manageCalendarsEnterNewName]: "Введіть нову назву календаря:",
        [_.manageCalendarsRenameSuccess]: "Календар успішно перейменовано",
        [_.manageCalendarsRenameError]: "Помилка перейменування календаря",
        [_.manageCalendarsUnknown]: "Невідомо",
        [_.manageCalendarsDeleteCalendar]: "Видалити",
        [_.manageCalendarsSmartCompletion]: "Розумне заповнення",
        [_.manageCalendarsSmartCompletionTooltip]: "Призначте категорію календаря кожному непризначеному стовпцю на основі потужності стовпця Рік. Призначте Рік вручну перед початком.",
        [_.manageCalendarsAcceptAllSuggestions]: "Прийняти всі пропозиції",
        [_.manageCalendarsHideUnassignedColumns]: "Приховати непризначені стовпці",
        [_.manageCalendarsLegendPrimary]: "Основний",
        [_.manageCalendarsLegendPrimaryTooltip]: "Основний стовпець для відповідної категорії",
        [_.manageCalendarsLegendAssociated]: "Пов'язаний",
        [_.manageCalendarsLegendAssociatedTooltip]: "Пов'язаний стовпець для відповідної категорії",
        [_.manageCalendarsLegendLinked]: "З'єднаний",
        [_.manageCalendarsLegendLinkedTooltip]: "Неявно пов'язаний стовпець для відповідної категорії, тому що він використовується для сортування основного або пов'язаного стовпця",
        [_.manageCalendarsColumnHeaderValues]: "# ЗНАЧЕННЯ",
        [_.manageCalendarsPromoteTooltip]: "Натисніть, щоб зробити це основним стовпцем",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Натисніть, щоб видалити призначення",
        [_.manageCalendarsImplicitColumnTooltip]: "Неявно пов'язаний стовпець для відповідної категорії через зв'язок SortByColumn. Натисніть, щоб зробити його основним стовпцем.",
        [_.manageCalendarsCardinalityWarningTooltip]: "Потужність {actualCardinality} не відповідає очікуваному значенню {expectedCardinality} для категорії {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Видалити первинне призначення для {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Підвищити {categoryName} до первинного",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Пов'язаний стовпець через SortByColumn для {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Попередження про потужність: знайдено {actualCardinality}, очікувалося {expectedCardinality}",
        [_.manageCalendarsGridAriaLabel]: "Зіставлення стовпців календаря",
        [_.manageCalendarsCellAriaLabel]: "{columnName} для календаря {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} оновлено до {categoryName}",
