...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Используйте учетные данные системы",
        [_.optionProxyDefaultCredentialsDescription]: `Используйте учетные данные системы по умолчанию для аутентификации на прокси -сервер. <span class="hl">эта опция выключена, пользовательские учетные данные были сохранены на вашем компьютере.</span>`,
