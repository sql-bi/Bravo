...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Обфусцировано",
        [_.docObfuscatedTooltip]: "Этот документ был загружен из обфусцированного файла VPAX. Нажмите, чтобы деобфусцировать его.",
        [_.deobfuscateDialogTitle]: "Деобфусцировать VPAX",
        [_.deobfuscateDialogDragFile]: "Перетащите сюда файл словаря VPAX<br>или найдите его на своём компьютере",
        [_.deobfuscateDialogNote]: "Файл словаря (.dict) необходим для деобфусцирования файла VPAX. Он используется исключительно в этих целях и никогда не передаётся, не сохраняется и не отправляется за пределы этого приложения.",
        ...
        [_.errorCheckForUpdates]: "Невозможно проверить наличие обновлений - подробности смотрите в панели диагностика.",
        ...
        [_.errorOperationFailedDetails]: "Произошла ошибка. Подробности смотрите в панели диагностика.",
