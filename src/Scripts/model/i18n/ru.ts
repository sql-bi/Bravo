...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devShowInFolder]: "Показать в исследователе файла",
        ...
        [_.errorPathNotFound]: "Путь не найден, или у вас нет права открыть его.",
        ...
        [_.helpOptions]: "Опции",
        [_.helpUserInterface]: "Пользовательский интерфейс",
        [_.helpTemplates]: "Даты шаблонов",
        ...
        [_.manageDatesTemplateNameConfig02]: "Стандарт - Фискальный",
        [_.manageDatesTemplateNameConfig03]: "Ежемесячный",
        [_.manageDatesTemplateNameConfig04]: "Ежемесячный - Фискальный",
        [_.manageDatesTemplateNameConfig05]: "Пользовательский",
        [_.manageDatesTemplateNameConfig06]: "Пользовательский - Фискальный",
        [_.manageDatesTemplateNameConfig07]: "Еженедельный",
        ...
        [_.manageCalendarsTableLabel]: "Таблица:",
        [_.manageCalendarsAddCalendar]: "Добавить календарь",
        [_.manageCalendarsTitle]: "Календари",
        [_.manageCalendarsColumnMapping]: "Сопоставление столбцов",
        [_.manageCalendarsLoadError]: "Ошибка загрузки календарей таблицы",
        [_.manageCalendarsNoCalendars]: "Для этой таблицы не определено ни одного календаря",
        [_.manageCalendarsDeleteButton]: "Удалить",
        [_.manageCalendarsColumnName]: "Столбец",
        [_.manageCalendarsSampleValues]: "Образцы значений",
        [_.manageCalendarsBlank]: "(пусто)",
        [_.manageCalendarsUnassigned]: "Не назначено",
        [_.manageCalendarsDate]: "Дата",
        [_.manageCalendarsYear]: "Год",
        [_.manageCalendarsSemester]: "Семестр",
        [_.manageCalendarsSemesterOfYear]: "Семестр года",
        [_.manageCalendarsQuarter]: "Квартал",
        [_.manageCalendarsQuarterOfYear]: "Квартал года",
        [_.manageCalendarsQuarterOfSemester]: "Квартал семестра",
        [_.manageCalendarsMonth]: "Месяц",
        [_.manageCalendarsMonthOfYear]: "Месяц года",
        [_.manageCalendarsMonthOfSemester]: "Месяц семестра",
        [_.manageCalendarsMonthOfQuarter]: "Месяц квартала",
        [_.manageCalendarsWeek]: "Неделя",
        [_.manageCalendarsWeekOfYear]: "Неделя года",
        [_.manageCalendarsWeekOfSemester]: "Неделя семестра",
        [_.manageCalendarsWeekOfQuarter]: "Неделя квартала",
        [_.manageCalendarsWeekOfMonth]: "Неделя месяца",
        [_.manageCalendarsDayOfYear]: "День года",
        [_.manageCalendarsDayOfSemester]: "День семестра",
        [_.manageCalendarsDayOfQuarter]: "День квартала",
        [_.manageCalendarsDayOfMonth]: "День месяца",
        [_.manageCalendarsDayOfWeek]: "День недели",
        [_.manageCalendarsTimeRelated]: "Связано со временем",
        [_.manageCalendarsUpdateSuccess]: "Календарь успешно обновлен",
        [_.manageCalendarsUpdateError]: "Ошибка обновления календаря",
        [_.manageCalendarsEnterName]: "Введите название календаря:",
        [_.manageCalendarsCreateSuccess]: "Календарь успешно создан",
        [_.manageCalendarsCreateError]: "Ошибка создания календаря",
        [_.manageCalendarsConfirmDelete]: "Вы уверены, что хотите удалить календарь '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Календарь успешно удален",
        [_.manageCalendarsDeleteError]: "Ошибка удаления календаря",
        [_.manageCalendarsRenameCalendar]: "Переименовать",
        [_.manageCalendarsEnterNewName]: "Введите новое название календаря:",
        [_.manageCalendarsRenameSuccess]: "Календарь успешно переименован",
        [_.manageCalendarsRenameError]: "Ошибка переименования календаря",
        [_.manageCalendarsUnknown]: "Неизвестно",
        [_.manageCalendarsDeleteCalendar]: "Удалить",
        [_.manageCalendarsSmartCompletion]: "Умное заполнение",
        [_.manageCalendarsSmartCompletionTooltip]: "Назначить категорию календаря каждому неназначенному столбцу на основе мощности столбца Год. Назначьте Год вручную перед началом.",
        [_.manageCalendarsAcceptAllSuggestions]: "Принять все предложения",
        [_.manageCalendarsHideUnassignedColumns]: "Скрыть неназначенные столбцы",
        [_.manageCalendarsLegendPrimary]: "Основной",
        [_.manageCalendarsLegendPrimaryTooltip]: "Основной столбец для соответствующей категории",
        [_.manageCalendarsLegendAssociated]: "Связанный",
        [_.manageCalendarsLegendAssociatedTooltip]: "Связанный столбец для соответствующей категории",
        [_.manageCalendarsLegendLinked]: "Связанный",
        [_.manageCalendarsLegendLinkedTooltip]: "Неявно связанный столбец для соответствующей категории, потому что он используется для сортировки основного или связанного столбца",
        [_.manageCalendarsColumnHeaderValues]: "# ЗНАЧЕНИЯ",
        [_.manageCalendarsPromoteTooltip]: "Нажмите, чтобы сделать этот столбец основным",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Нажмите, чтобы удалить назначение",
        [_.manageCalendarsImplicitColumnTooltip]: "Неявно связанный столбец для соответствующей категории через связь SortByColumn. Нажмите, чтобы сделать его основным столбцом.",
        [_.manageCalendarsCardinalityWarningTooltip]: "Мощность {actualCardinality} не соответствует ожидаемому значению {expectedCardinality} для категории {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Удалить первичное назначение для {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Повысить {categoryName} до первичного",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Связанный столбец через SortByColumn для {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Предупреждение о мощности: найдено {actualCardinality}, ожидалось {expectedCardinality}",
        [_.manageCalendarsGridAriaLabel]: "Сопоставление столбцов календаря",
        [_.manageCalendarsCellAriaLabel]: "{columnName} для календаря {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} обновлен до {categoryName}",
        ...
        [_.optionDev]: "Включить шаблоны даты пользователя",
        ...
        [_.optionsDialogDevMenu]: "Шаблоны",
