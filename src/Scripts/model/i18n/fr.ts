...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Utiliser les informations d'identification du système",
        [_.optionProxyDefaultCredentialsDescription]: `Utilisez les informations d'identification par défaut du système pour vous authentifier avec le serveur proxy. <span class="hl">it Cette option est désactivée, les informations d'identification personnalisées ont été enregistrées sur votre ordinateur.</span>`,
