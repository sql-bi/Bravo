...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Obfusqué",
        [_.docObfuscatedTooltip]: "Ce document a été chargé depuis un fichier VPAX obfusqué. Cliquez pour le désobfusquer.",
        [_.deobfuscateDialogTitle]: "Désobfusquer VPAX",
        [_.deobfuscateDialogDragFile]: "Faites glisser le fichier dictionnaire VPAX ici<br>ou parcourez votre ordinateur",
        [_.deobfuscateDialogNote]: "Le fichier dictionnaire (.dict) est requis pour désobfusquer le fichier VPAX. Il est utilisé exclusivement à cette fin et n'est jamais partagé, stocké ou transmis en dehors de cette application.",
        ...
        [_.errorOperationFailedDetails]: "Une erreur s'est produite. Consultez le panneau diagnostics pour plus de détails.",
