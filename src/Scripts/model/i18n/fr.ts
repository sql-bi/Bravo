...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devTemplatesNotAvailable]: "Ce modèle n'est pas plus disponible.",
        ...
        [_.devTemplatesVSCodeMessage]: "<p>Le projet de modèle de date sera maintenant ouvert avec Visual Studio Code et nécessite la compilation <b>{extension}</b>. </p><p>Si ce n'est pas déjà disponible sur votre système, utilisezLe lien ci-dessous pour les télécharger et les installer:</p> ",
        [_.devTemplatesVSCodeTitle]: "Ouvert avec Visual Studio Code",
        [_.dialogCancel]: "Annuler",
        [_.dialogContinue]: "Continuer",
        [_.dialogNeverShowAgain]: "Ne montrez plus ça",
        [_.dialogOK]: "OK",
        [_.dialogOpen]: "Ouvrir",
        [_.docLimited]: "Limité",
        ...
        [_.optionProxyBypassListDescription]: "Utilisez le serveur proxy, sauf pour les adresses qui commencent par les entrées insérées.Utilisez des semi-colons (;) pour séparer les entrées.",
