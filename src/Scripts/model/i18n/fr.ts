...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.manageCalendarsTableLabel]: "Table :",
        [_.manageCalendarsAddCalendar]: "Ajouter un Calendrier",
        [_.manageCalendarsTitle]: "Calendriers",
        [_.manageCalendarsColumnMapping]: "Mappage des Colonnes",
        [_.manageCalendarsLoadError]: "Échec du chargement des calendriers de table",
        [_.manageCalendarsNoCalendars]: "Aucun calendrier défini pour cette table",
        [_.manageCalendarsDeleteButton]: "Supprimer",
        [_.manageCalendarsColumnName]: "Colonne",
        [_.manageCalendarsSampleValues]: "Valeurs d'Exemple",
        [_.manageCalendarsBlank]: "(vide)",
        [_.manageCalendarsUnassigned]: "Non assigné",
        [_.manageCalendarsDate]: "Date",
        [_.manageCalendarsYear]: "Année",
        [_.manageCalendarsSemester]: "Semestre",
        [_.manageCalendarsSemesterOfYear]: "Semestre de l'Année",
        [_.manageCalendarsQuarter]: "Trimestre",
        [_.manageCalendarsQuarterOfYear]: "Trimestre de l'Année",
        [_.manageCalendarsQuarterOfSemester]: "Trimestre du Semestre",
        [_.manageCalendarsMonth]: "Mois",
        [_.manageCalendarsMonthOfYear]: "Mois de l'Année",
        [_.manageCalendarsMonthOfSemester]: "Mois du Semestre",
        [_.manageCalendarsMonthOfQuarter]: "Mois du Trimestre",
        [_.manageCalendarsWeek]: "Semaine",
        [_.manageCalendarsWeekOfYear]: "Semaine de l'Année",
        [_.manageCalendarsWeekOfSemester]: "Semaine du Semestre",
        [_.manageCalendarsWeekOfQuarter]: "Semaine du Trimestre",
        [_.manageCalendarsWeekOfMonth]: "Semaine du Mois",
        [_.manageCalendarsDayOfYear]: "Jour de l'Année",
        [_.manageCalendarsDayOfSemester]: "Jour du Semestre",
        [_.manageCalendarsDayOfQuarter]: "Jour du Trimestre",
        [_.manageCalendarsDayOfMonth]: "Jour du Mois",
        [_.manageCalendarsDayOfWeek]: "Jour de la Semaine",
        [_.manageCalendarsTimeRelated]: "Lié au Temps",
        [_.manageCalendarsUpdateSuccess]: "Calendrier mis à jour avec succès",
        [_.manageCalendarsUpdateError]: "Échec de la mise à jour du calendrier",
        [_.manageCalendarsEnterName]: "Entrez le nom du calendrier :",
        [_.manageCalendarsCreateSuccess]: "Calendrier créé avec succès",
        [_.manageCalendarsCreateError]: "Échec de la création du calendrier",
        [_.manageCalendarsConfirmDelete]: "Êtes-vous sûr de vouloir supprimer le calendrier '{0}' ?",
        [_.manageCalendarsDeleteSuccess]: "Calendrier supprimé avec succès",
        [_.manageCalendarsDeleteError]: "Échec de la suppression du calendrier",
        [_.manageCalendarsRenameCalendar]: "Renommer",
        [_.manageCalendarsEnterNewName]: "Entrez le nouveau nom du calendrier :",
        [_.manageCalendarsRenameSuccess]: "Calendrier renommé avec succès",
        [_.manageCalendarsRenameError]: "Échec du renommage du calendrier",
        [_.manageCalendarsUnknown]: "Inconnu",
        [_.manageCalendarsDeleteCalendar]: "Supprimer",
        [_.manageCalendarsSmartCompletion]: "Complétion intelligente",
        [_.manageCalendarsSmartCompletionTooltip]: "Attribuer une catégorie de calendrier à chaque colonne non assignée en fonction de la cardinalité de la colonne Année. Assignez Année manuellement avant de commencer.",
        [_.manageCalendarsAcceptAllSuggestions]: "Accepter toutes les suggestions",
        [_.manageCalendarsHideUnassignedColumns]: "Masquer les colonnes non assignées",
        [_.manageCalendarsLegendPrimary]: "Principal",
        [_.manageCalendarsLegendPrimaryTooltip]: "Colonne principale pour la catégorie associée",
        [_.manageCalendarsLegendAssociated]: "Associé",
        [_.manageCalendarsLegendAssociatedTooltip]: "Colonne associée pour la catégorie associée",
        [_.manageCalendarsLegendLinked]: "Lié",
        [_.manageCalendarsLegendLinkedTooltip]: "Colonne implicitement associée pour la catégorie associée car elle est utilisée pour trier une colonne principale ou associée",
        [_.manageCalendarsColumnHeaderValues]: "# VALEURS",
        [_.manageCalendarsPromoteTooltip]: "Cliquez pour en faire la colonne principale",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Cliquez pour supprimer l'attribution",
        [_.manageCalendarsImplicitColumnTooltip]: "Colonne implicitement associée pour la catégorie associée via la relation SortByColumn. Cliquez pour en faire la colonne principale.",
        [_.manageCalendarsCardinalityWarningTooltip]: "La cardinalité de {actualCardinality} ne correspond pas à la valeur attendue de {expectedCardinality} pour la catégorie {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Supprimer l'attribution principale pour {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Promouvoir {categoryName} en principal",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Colonne liée via SortByColumn pour {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Avertissement de cardinalité : {actualCardinality} trouvé, {expectedCardinality} attendu",
        [_.manageCalendarsGridAriaLabel]: "Mappages des colonnes de calendrier",
        [_.manageCalendarsCellAriaLabel]: "{columnName} pour le calendrier {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} mis à jour vers {categoryName}",
