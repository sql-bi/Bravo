...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Obfuskiert",
        [_.docObfuscatedTooltip]: "Dieses Dokument wurde aus einer obfuskirten VPAX-Datei geladen. Klicken Sie hier, um es zu deobfuskieren.",
        [_.deobfuscateDialogTitle]: "VPAX deobfuskieren",
        [_.deobfuscateDialogDragFile]: "Wörterbuchdatei hier hineinziehen<br>oder auf dem Computer suchen",
        [_.deobfuscateDialogNote]: "Die Wörterbuchdatei (.dict) ist erforderlich, um die VPAX-Datei zu deobfuskieren. Sie wird ausschließlich für diesen Zweck verwendet und niemals außerhalb dieser Anwendung geteilt, gespeichert oder übertragen.",
        ...
        [_.errorOperationFailedDetails]: "Ein Fehler ist aufgetreten. Details finden Sie im Diagnosebereich.",
