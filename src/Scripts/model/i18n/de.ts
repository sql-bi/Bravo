...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devCreateTemplateDialogOk]: "Schaffen",
        [_.devCreateTemplateLabelModel]: "Bezogen auf",
        [_.devCreateTemplateLabelName]: "Vorlagenname",
        ...
        [_.devShowInFolder]: "In Datei Explorer anzeigen",
        ...
        [_.devTemplatesCreate]: "Neue Vorlage",
        [_.devTemplatesEdit]: "Bearbeiten",
        [_.devTemplatesEditTitle]: "Bearbeiten im Visual Studio Code",
        [_.devTemplatesEmpty]: "Keine benutzerdefinierten Datumsvorlagen gefunden.",
        [_.devTemplatesNotAvailable]: "Diese Vorlage ist nicht mehr verfügbar.",
        [_.devTemplatesRemove]: "Entfernen",
        [_.devTemplatesTypeOrganization]: "Organisation",
        [_.devTemplatesTypeUser]: "Benutzer",
        [_.devTemplatesVSCodeDownload]: "Download Visual Studio Code",
        [_.devTemplatesVSCodeExtensionDownload]: "Download {extension}",
        [_.devTemplatesVSCodeMessage]: "<p>Das Datumsvorlageprojekt wird jetzt mit Visual Studio Code geöffnet und benötigt die Erweiterung <b>{extension}</b>, um zu kompilieren.</p><p>Wenn nicht bereits in Ihrem System verfügbar istDer Link unten zum Herunterladen und Installieren:</p> ",
        [_.devTemplatesVSCodeTitle]: "Öffnen mit Visual Studio Code",
        [_.dialogCancel]: "Abbrechen",
        [_.dialogContinue]: "Fortsetzen",
        [_.dialogNeverShowAgain]: "Zeigen Sie das nicht noch einmal",
        [_.dialogOK]: "OK",
        [_.dialogOpen]: "Öffnen",
        ...
        [_.errorPathNotFound]: "Path nicht gefunden oder Sie haben nicht das Recht, es zu öffnen.",
        ...
        [_.helpOptions]: "Optionen",
        [_.helpUserInterface]: "Benutzeroberfläche",
        [_.helpTemplates]: "Datenvorlagen",
        ...
        [_.manageDatesCalendarTemplateName]: "Schablone",
        ...
        [_.manageDatesManageTemplates]: "Vorlagen verwalten",
        ...
        [_.manageDatesTemplateNameConfig02]: "Standard - Fiskal",
        [_.manageDatesTemplateNameConfig03]: "Monatlich",
        [_.manageDatesTemplateNameConfig04]: "Monatlich - Fiskal",
        [_.manageDatesTemplateNameConfig05]: "Benutzerdefiniert",
        [_.manageDatesTemplateNameConfig06]: "Benutzerdefiniert - Fiskal",
        [_.manageDatesTemplateNameConfig07]: "Wöchentlich",
        ...
        [_.manageCalendarsTableLabel]: "Tabelle:",
        [_.manageCalendarsAddCalendar]: "Kalender hinzufügen",
        [_.manageCalendarsTitle]: "Kalender",
        [_.manageCalendarsColumnMapping]: "Spaltenzuordnung",
        [_.manageCalendarsLoadError]: "Fehler beim Laden der Tabellenkalender",
        [_.manageCalendarsNoCalendars]: "Keine Kalender für diese Tabelle definiert",
        [_.manageCalendarsDeleteButton]: "Löschen",
        [_.manageCalendarsColumnName]: "Spalte",
        [_.manageCalendarsSampleValues]: "Beispielwerte",
        [_.manageCalendarsBlank]: "(leer)",
        [_.manageCalendarsUnassigned]: "Nicht zugewiesen",
        [_.manageCalendarsDate]: "Datum",
        [_.manageCalendarsYear]: "Jahr",
        [_.manageCalendarsSemester]: "Semester",
        [_.manageCalendarsSemesterOfYear]: "Semester des Jahres",
        [_.manageCalendarsQuarter]: "Quartal",
        [_.manageCalendarsQuarterOfYear]: "Quartal des Jahres",
        [_.manageCalendarsQuarterOfSemester]: "Quartal des Semesters",
        [_.manageCalendarsMonth]: "Monat",
        [_.manageCalendarsMonthOfYear]: "Monat des Jahres",
        [_.manageCalendarsMonthOfSemester]: "Monat des Semesters",
        [_.manageCalendarsMonthOfQuarter]: "Monat des Quartals",
        [_.manageCalendarsWeek]: "Woche",
        [_.manageCalendarsWeekOfYear]: "Woche des Jahres",
        [_.manageCalendarsWeekOfSemester]: "Woche des Semesters",
        [_.manageCalendarsWeekOfQuarter]: "Woche des Quartals",
        [_.manageCalendarsWeekOfMonth]: "Woche des Monats",
        [_.manageCalendarsDayOfYear]: "Tag des Jahres",
        [_.manageCalendarsDayOfSemester]: "Tag des Semesters",
        [_.manageCalendarsDayOfQuarter]: "Tag des Quartals",
        [_.manageCalendarsDayOfMonth]: "Tag des Monats",
        [_.manageCalendarsDayOfWeek]: "Tag der Woche",
        [_.manageCalendarsTimeRelated]: "Zeitbezogen",
        [_.manageCalendarsUpdateSuccess]: "Kalender erfolgreich aktualisiert",
        [_.manageCalendarsUpdateError]: "Fehler beim Aktualisieren des Kalenders",
        [_.manageCalendarsEnterName]: "Kalendername eingeben:",
        [_.manageCalendarsCreateSuccess]: "Kalender erfolgreich erstellt",
        [_.manageCalendarsCreateError]: "Fehler beim Erstellen des Kalenders",
        [_.manageCalendarsConfirmDelete]: "Möchten Sie den Kalender '{0}' wirklich löschen?",
        [_.manageCalendarsDeleteSuccess]: "Kalender erfolgreich gelöscht",
        [_.manageCalendarsDeleteError]: "Fehler beim Löschen des Kalenders",
        [_.manageCalendarsRenameCalendar]: "Umbenennen",
        [_.manageCalendarsEnterNewName]: "Neuen Kalendernamen eingeben:",
        [_.manageCalendarsRenameSuccess]: "Kalender erfolgreich umbenannt",
        [_.manageCalendarsRenameError]: "Fehler beim Umbenennen des Kalenders",
        [_.manageCalendarsUnknown]: "Unbekannt",
        [_.manageCalendarsDeleteCalendar]: "Löschen",
        [_.manageCalendarsSmartCompletion]: "Intelligente Vervollständigung",
        [_.manageCalendarsSmartCompletionTooltip]: "Weisen Sie jeder nicht zugewiesenen Spalte eine Kalenderkategorie basierend auf der Kardinalität der Jahresspalte zu. Weisen Sie Jahr manuell zu, bevor Sie beginnen.",
        [_.manageCalendarsAcceptAllSuggestions]: "Alle Vorschläge akzeptieren",
        [_.manageCalendarsHideUnassignedColumns]: "Nicht zugewiesene Spalten ausblenden",
        [_.manageCalendarsLegendPrimary]: "Primär",
        [_.manageCalendarsLegendPrimaryTooltip]: "Primärspalte für die zugehörige Kategorie",
        [_.manageCalendarsLegendAssociated]: "Zugeordnet",
        [_.manageCalendarsLegendAssociatedTooltip]: "Zugeordnete Spalte für die zugehörige Kategorie",
        [_.manageCalendarsLegendLinked]: "Verknüpft",
        [_.manageCalendarsLegendLinkedTooltip]: "Implizit zugeordnete Spalte für die zugehörige Kategorie, weil sie zur Sortierung einer primären oder zugeordneten Spalte verwendet wird",
        [_.manageCalendarsColumnHeaderValues]: "# WERTE",
        [_.manageCalendarsPromoteTooltip]: "Klicken Sie, um dies zur Primärspalte zu machen",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Klicken Sie, um die Zuweisung zu entfernen",
        [_.manageCalendarsImplicitColumnTooltip]: "Implizit zugeordnete Spalte für die zugehörige Kategorie über SortByColumn-Beziehung. Klicken Sie, um sie zur Primärspalte zu machen.",
        [_.manageCalendarsCardinalityWarningTooltip]: "Die Kardinalität von {actualCardinality} entspricht nicht dem erwarteten Wert von {expectedCardinality} für die Kategorie {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Primärzuweisung für {categoryName} entfernen",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "{categoryName} zu Primär hochstufen",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Verknüpfte Spalte über SortByColumn für {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Kardinalitätswarnung: {actualCardinality} gefunden, {expectedCardinality} erwartet",
        [_.manageCalendarsGridAriaLabel]: "Kalenderspaltenzuordnungen",
        [_.manageCalendarsCellAriaLabel]: "{columnName} für Kalender {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} auf {categoryName} aktualisiert",
        ...
        [_.optionDev]: "Aktivieren Sie Benutzerdatumvorlagen",
        ...
        [_.optionPolicyNotice]: "Diese Option wird von Ihrer Organisation verwaltet.",
        ...
        [_.optionResetAlerts]: "Benachrichtigungen wiederherstellen",
        [_.optionResetAlertsButton]: "Wiederherstellen",
        [_.optionResetAlertsDescription]: "Alle manuell versteckten Warnungen wiederherstellen.",
        [_.optionsDialogAboutMenu]: "Über",
        [_.optionsDialogDevMenu]: "Vorlagen",
