...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Zaciemniony",
        [_.docObfuscatedTooltip]: "Ten dokument został załadowany z zaciemnionego pliku VPAX. Kliknij, aby go odciemnić.",
        [_.deobfuscateDialogTitle]: "Odciemnij VPAX",
        [_.deobfuscateDialogDragFile]: "Przeciągnij tutaj plik słownika VPAX<br>lub wyszukaj go na swoim komputerze",
        [_.deobfuscateDialogNote]: "Plik słownika (.dict) jest wymagany do odciemnienia pliku VPAX. Jest używany wyłącznie w tym celu i nigdy nie jest udostępniany, przechowywany ani przesyłany poza tą aplikacją.",
        ...
        [_.errorCheckForUpdates]: "Nie możemy sprawdzić aktualizacji - szczegóły znajdziesz w panelu diagnostyka.",
