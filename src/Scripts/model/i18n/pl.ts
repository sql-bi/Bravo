...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Użyj poświadczeń systemowych",
        [_.optionProxyDefaultCredentialsDescription]: `Użyj domyślnych poświadczeń systemowych, aby uwierzytelnić się na serwerze proxy. <span class="hl">Ta opcja jest wyłączona, na komputerze zapisano niestandardowe poświadczenia.</span>`,
