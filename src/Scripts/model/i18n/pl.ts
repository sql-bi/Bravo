...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devCreateTemplateDialogOk]: "Tworzyć",
        [_.devCreateTemplateLabelModel]: "Oparte na",
        [_.devCreateTemplateLabelName]: "Nazwa szablonu",
        ...
        [_.devShowInFolder]: "Pokaż w eksploratorze plików",
        ...
        [_.devTemplatesColType]: "Rodzaj",
        [_.devTemplatesCreate]: "Nowy szablon",
        [_.devTemplatesEdit]: "Edytować",
        [_.devTemplatesEditTitle]: "Edytuj w Visual Studio Code",
        [_.devTemplatesEmpty]: "Nie znaleziono niestandardowych szablonów dat.",
        [_.devTemplatesNotAvailable]: "Ten szablon nie jest bardziej dostępny.",
        [_.devTemplatesRemove]: "Usunąć",
        [_.devTemplatesTypeOrganization]: "Organizacja",
        [_.devTemplatesTypeUser]: "Użytkownik",
        [_.devTemplatesVSCodeDownload]: "Pobierz Visual Studio Code",
        [_.devTemplatesVSCodeExtensionDownload]: "Pobierz {extension}",
        [_.devTemplatesVSCodeMessage]: "<p> Projekt szablonu daty zostanie teraz otwarty z Visual Studio Code i wymaga rozszerzenia <b>{extension}</b>, które zostanie skompilowane.</p><p>Jeśli nie jest już dostępny w systemie, użyj, użyj, używaj,Poniższy link do pobrania i zainstalowania:</p>",
        [_.devTemplatesVSCodeTitle]: "Otwórz Visual Studio Code",
        [_.dialogCancel]: "Anuluj",
        [_.dialogContinue]: "Kontynuować",
        [_.dialogNeverShowAgain]: "Nie pokazuj tego ponownie",
        [_.dialogOK]: "OK",
        [_.dialogOpen]: "Otwórz",
        [_.docLimited]: "Ograniczone",
        [_.docLimitedTooltip]: "Nie wszystkie funkcje są obecnie dostępne.",
        [_.documentation]: "Dokumentacja",
        ...
        [_.errorReportConnectionUnsupportedAnalysisServicesConnectionNotFound]: "Nie znaleziono połączenia TCP z Power BI Desktop Analysis Services.",
        [_.errorReportConnectionUnsupportedAnalysisServicesProcessNotFound]: "Nie znaleziono instancji połączenia z Power BI Desktop Analysis Services.", 
        ...
        [_.errorReportConnectionUnsupportedDatabaseCollectionEmpty]: "Instancja Power BI Desktop Analysis Services nie zawiera żadnych baz danych. Spróbuj połączyć się z raportem używając ikony Bravo w zakładce narzędzia zewnętrzne Power BI Desktop.",
        ...
        [_.errorReportConnectionUnsupportedProcessNotReady]: "Power BI Desktop uruchamia się lub instancja Analysis Services nie jest jeszcze gotowa.", 
        ...
        [_.helpOptions]: "Opcje",
        [_.helpUserInterface]: "Interfejs użytkownika",
        [_.helpTemplates]: "Daty szablony",
        ...
        [_.manageDatesCalendarTemplateName]: "Szablon",
        ...
        [_.manageDatesManageTemplates]: "Zarządzaj szablonami",
        ...
        [_.manageDatesTemplateNameConfig02]: "Standard - Fiskalny",
        [_.manageDatesTemplateNameConfig03]: "Miesięczny",
        [_.manageDatesTemplateNameConfig04]: "Miesięczny - Fiskalny",
        [_.manageDatesTemplateNameConfig05]: "Niestandardowy",
        [_.manageDatesTemplateNameConfig06]: "Niestandardowy - Fiskalny",
        [_.manageDatesTemplateNameConfig07]: "Tygodniowy",
        [_.manageDatesTemplateNameCurrent]: "Aktualny",
        ...
        [_.manageCalendarsTableLabel]: "Tabela:",
        [_.manageCalendarsAddCalendar]: "Dodaj Kalendarz",
        [_.manageCalendarsTitle]: "Kalendarze",
        [_.manageCalendarsColumnMapping]: "Mapowanie Kolumn",
        [_.manageCalendarsLoadError]: "Nie udało się załadować kalendarzy tabeli",
        [_.manageCalendarsNoCalendars]: "Brak zdefiniowanych kalendarzy dla tej tabeli",
        [_.manageCalendarsDeleteButton]: "Usuń",
        [_.manageCalendarsColumnName]: "Kolumna",
        [_.manageCalendarsSampleValues]: "Przykładowe Wartości",
        [_.manageCalendarsBlank]: "(puste)",
        [_.manageCalendarsUnassigned]: "Nieprzypisane",
        [_.manageCalendarsDate]: "Data",
        [_.manageCalendarsYear]: "Rok",
        [_.manageCalendarsSemester]: "Semestr",
        [_.manageCalendarsSemesterOfYear]: "Semestr Roku",
        [_.manageCalendarsQuarter]: "Kwartał",
        [_.manageCalendarsQuarterOfYear]: "Kwartał Roku",
        [_.manageCalendarsQuarterOfSemester]: "Kwartał Semestru",
        [_.manageCalendarsMonth]: "Miesiąc",
        [_.manageCalendarsMonthOfYear]: "Miesiąc Roku",
        [_.manageCalendarsMonthOfSemester]: "Miesiąc Semestru",
        [_.manageCalendarsMonthOfQuarter]: "Miesiąc Kwartału",
        [_.manageCalendarsWeek]: "Tydzień",
        [_.manageCalendarsWeekOfYear]: "Tydzień Roku",
        [_.manageCalendarsWeekOfSemester]: "Tydzień Semestru",
        [_.manageCalendarsWeekOfQuarter]: "Tydzień Kwartału",
        [_.manageCalendarsWeekOfMonth]: "Tydzień Miesiąca",
        [_.manageCalendarsDayOfYear]: "Dzień Roku",
        [_.manageCalendarsDayOfSemester]: "Dzień Semestru",
        [_.manageCalendarsDayOfQuarter]: "Dzień Kwartału",
        [_.manageCalendarsDayOfMonth]: "Dzień Miesiąca",
        [_.manageCalendarsDayOfWeek]: "Dzień Tygodnia",
        [_.manageCalendarsTimeRelated]: "Związane z Czasem",
        [_.manageCalendarsUpdateSuccess]: "Kalendarz został pomyślnie zaktualizowany",
        [_.manageCalendarsUpdateError]: "Nie udało się zaktualizować kalendarza",
        [_.manageCalendarsEnterName]: "Wprowadź nazwę kalendarza:",
        [_.manageCalendarsCreateSuccess]: "Kalendarz został pomyślnie utworzony",
        [_.manageCalendarsCreateError]: "Nie udało się utworzyć kalendarza",
        [_.manageCalendarsConfirmDelete]: "Czy na pewno chcesz usunąć kalendarz '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Kalendarz został pomyślnie usunięty",
        [_.manageCalendarsDeleteError]: "Nie udało się usunąć kalendarza",
        [_.manageCalendarsRenameCalendar]: "Zmień nazwę",
        [_.manageCalendarsEnterNewName]: "Wprowadź nową nazwę kalendarza:",
        [_.manageCalendarsRenameSuccess]: "Kalendarz został pomyślnie przemianowany",
        [_.manageCalendarsRenameError]: "Nie udało się przemianować kalendarza",
        [_.manageCalendarsUnknown]: "Nieznane",
        [_.manageCalendarsDeleteCalendar]: "Usuń",
        [_.manageCalendarsSmartCompletion]: "Inteligentne uzupełnianie",
        [_.manageCalendarsSmartCompletionTooltip]: "Przypisz kategorię kalendarza do każdej nieprzypisanej kolumny na podstawie kardynalności kolumny Rok. Przypisz Rok ręcznie przed rozpoczęciem.",
        [_.manageCalendarsAcceptAllSuggestions]: "Zaakceptuj wszystkie sugestie",
        [_.manageCalendarsHideUnassignedColumns]: "Ukryj nieprzypisane kolumny",
        [_.manageCalendarsLegendPrimary]: "Główna",
        [_.manageCalendarsLegendPrimaryTooltip]: "Główna kolumna dla powiązanej kategorii",
        [_.manageCalendarsLegendAssociated]: "Powiązana",
        [_.manageCalendarsLegendAssociatedTooltip]: "Powiązana kolumna dla powiązanej kategorii",
        [_.manageCalendarsLegendLinked]: "Połączona",
        [_.manageCalendarsLegendLinkedTooltip]: "Kolumna pośrednio powiązana z powiązaną kategorią, ponieważ jest używana do sortowania głównej lub powiązanej kolumny",
        [_.manageCalendarsColumnHeaderValues]: "# WARTOŚCI",
        [_.manageCalendarsPromoteTooltip]: "Kliknij, aby uczynić tę kolumnę główną",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Kliknij, aby usunąć przypisanie",
        [_.manageCalendarsImplicitColumnTooltip]: "Kolumna pośrednio powiązana z powiązaną kategorią przez relację SortByColumn. Kliknij, aby uczynić ją kolumną główną.",
        [_.manageCalendarsCardinalityWarningTooltip]: "Kardynalność {actualCardinality} nie odpowiada oczekiwanej wartości {expectedCardinality} dla kategorii {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Usuń przypisanie główne dla {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Promuj {categoryName} do głównej",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Połączona kolumna przez SortByColumn dla {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Ostrzeżenie kardynalności: znaleziono {actualCardinality}, oczekiwano {expectedCardinality}",
        [_.manageCalendarsGridAriaLabel]: "Mapowanie kolumn kalendarza",
        [_.manageCalendarsCellAriaLabel]: "{columnName} dla kalendarza {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} zaktualizowano do {categoryName}",
        ...
        [_.optionDev]: "Włącz szablony dat użytkownika",
        ...
        [_.optionInvalidValue]: "Niewłaściwa wartość",
        ...
        [_.optionPolicyNotice]: "Tą opcją zarządza Twoja organizacja.",
        [_.optionProxyAddress]: "Adres serwera proxy",
        [_.optionProxyAddressDescription]: "Podaj adres swojego serwera proxy.",
        [_.optionProxyBypassList]: "Wyklucz listę adresów",
        ...
        [_.optionProxyType]: "Serwer proxy",
        [_.optionProxyTypeCustom]: "Zwyczaj",
        [_.optionProxyTypeDescription]: "Wybierz serwer proxy.",
        [_.optionProxyTypeNone]: "Nic",
        [_.optionProxyTypeSystem]: "system",
        [_.optionResetAlerts]: "Przywróć alerty",
        [_.optionResetAlertsButton]: "Przywrócić",
        [_.optionResetAlertsDescription]: "Przywróć wszystkie ręcznie ukryte alerty.",
        [_.optionsDialogAboutMenu]: "Informacje",
        [_.optionsDialogDevMenu]: "Szablony",
        [_.optionsDialogFormattingMenu]: "Formatowanie",
        [_.optionsDialogGeneralMenu]: "Ogólne",
        [_.optionsDialogProxyMenu]: "Pełnomocnik",
