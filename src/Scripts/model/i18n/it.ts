...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Usa Credenziali del Sistema",
        [_.optionProxyDefaultCredentialsDescription]: `Utilizza le credenziali predefinite del sistema per autenticarti sul server proxy. <span class="hl">Se questa opzione è disattivata, le credenziali personalizzate sono state salvate sul tuo computer.</span> `,
