...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.helpOptions]: "Opzioni",
        [_.helpUserInterface]: "Interfaccia Utente",
        [_.helpTemplates]: "Template Date",
        ...
        [_.manageCalendarsTableLabel]: "Tabella:",
        [_.manageCalendarsAddCalendar]: "Aggiungi Calendario",
        [_.manageCalendarsTitle]: "Calendari",
        [_.manageCalendarsColumnMapping]: "Mappatura Colonne",
        [_.manageCalendarsLoadError]: "Impossibile caricare i calendari della tabella",
        [_.manageCalendarsNoCalendars]: "Nessun calendario definito per questa tabella",
        [_.manageCalendarsDeleteButton]: "Elimina",
        [_.manageCalendarsColumnName]: "Colonna",
        [_.manageCalendarsSampleValues]: "Valori di Esempio",
        [_.manageCalendarsBlank]: "(vuoto)",
        [_.manageCalendarsUnassigned]: "Non assegnato",
        [_.manageCalendarsDate]: "Data",
        [_.manageCalendarsYear]: "Anno",
        [_.manageCalendarsSemester]: "Semestre",
        [_.manageCalendarsSemesterOfYear]: "Semestre dell'Anno",
        [_.manageCalendarsQuarter]: "Trimestre",
        [_.manageCalendarsQuarterOfYear]: "Trimestre dell'Anno",
        [_.manageCalendarsQuarterOfSemester]: "Trimestre del Semestre",
        [_.manageCalendarsMonth]: "Mese",
        [_.manageCalendarsMonthOfYear]: "Mese dell'Anno",
        [_.manageCalendarsMonthOfSemester]: "Mese del Semestre",
        [_.manageCalendarsMonthOfQuarter]: "Mese del Trimestre",
        [_.manageCalendarsWeek]: "Settimana",
        [_.manageCalendarsWeekOfYear]: "Settimana dell'Anno",
        [_.manageCalendarsWeekOfSemester]: "Settimana del Semestre",
        [_.manageCalendarsWeekOfQuarter]: "Settimana del Trimestre",
        [_.manageCalendarsWeekOfMonth]: "Settimana del Mese",
        [_.manageCalendarsDayOfYear]: "Giorno dell'Anno",
        [_.manageCalendarsDayOfSemester]: "Giorno del Semestre",
        [_.manageCalendarsDayOfQuarter]: "Giorno del Trimestre",
        [_.manageCalendarsDayOfMonth]: "Giorno del Mese",
        [_.manageCalendarsDayOfWeek]: "Giorno della Settimana",
        [_.manageCalendarsTimeRelated]: "Relativo al Tempo",
        [_.manageCalendarsUpdateSuccess]: "Calendario aggiornato con successo",
        [_.manageCalendarsUpdateError]: "Impossibile aggiornare il calendario",
        [_.manageCalendarsEnterName]: "Inserisci il nome del calendario:",
        [_.manageCalendarsCreateSuccess]: "Calendario creato con successo",
        [_.manageCalendarsCreateError]: "Impossibile creare il calendario",
        [_.manageCalendarsConfirmDelete]: "Sei sicuro di voler eliminare il calendario '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Calendario eliminato con successo",
        [_.manageCalendarsDeleteError]: "Impossibile eliminare il calendario",
        [_.manageCalendarsRenameCalendar]: "Rinomina",
        [_.manageCalendarsEnterNewName]: "Inserisci il nuovo nome del calendario:",
        [_.manageCalendarsRenameSuccess]: "Calendario rinominato con successo",
        [_.manageCalendarsRenameError]: "Impossibile rinominare il calendario",
        [_.manageCalendarsUnknown]: "Sconosciuto",
        [_.manageCalendarsDeleteCalendar]: "Elimina",
        [_.manageCalendarsSmartCompletion]: "Completamento automatico",
        [_.manageCalendarsSmartCompletionTooltip]: "Assegna una categoria di calendario a ogni colonna non assegnata in base alla cardinalità della colonna Anno. Assegna Anno manualmente prima di iniziare.",
        [_.manageCalendarsAcceptAllSuggestions]: "Accetta tutti i suggerimenti",
        [_.manageCalendarsHideUnassignedColumns]: "Nascondi colonne non assegnate",
        [_.manageCalendarsLegendPrimary]: "Principale",
        [_.manageCalendarsLegendPrimaryTooltip]: "Colonna principale per la categoria correlata",
        [_.manageCalendarsLegendAssociated]: "Associata",
        [_.manageCalendarsLegendAssociatedTooltip]: "Colonna associata per la categoria correlata",
        [_.manageCalendarsLegendLinked]: "Collegata",
        [_.manageCalendarsLegendLinkedTooltip]: "Colonna implicitamente associata per la categoria correlata perché usata per ordinare una colonna principale o associata",
        [_.manageCalendarsColumnHeaderValues]: "# VALORI",
        [_.manageCalendarsPromoteTooltip]: "Fai clic per renderla la colonna principale",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Fai clic per rimuovere l'assegnazione",
        [_.manageCalendarsImplicitColumnTooltip]: "Colonna implicitamente associata per la categoria correlata tramite relazione SortByColumn. Fai clic per renderla la colonna principale.",
        [_.manageCalendarsCardinalityWarningTooltip]: "La cardinalità di {actualCardinality} non corrisponde al valore atteso di {expectedCardinality} per la categoria {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Rimuovi assegnazione principale per {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Promuovi {categoryName} a principale",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Colonna collegata tramite SortByColumn per {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Avviso cardinalità: {actualCardinality} trovati, previsti {expectedCardinality}",
        [_.manageCalendarsGridAriaLabel]: "Mappature colonne calendario",
        [_.manageCalendarsCellAriaLabel]: "{columnName} per calendario {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} aggiornata a {categoryName}",
