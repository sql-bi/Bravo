...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Offuscato",
        [_.docObfuscatedTooltip]: "Questo documento è stato caricato da un file VPAX offuscato. Clicca per deoffuscarlo.",
        [_.deobfuscateDialogTitle]: "Deoffusca VPAX",
        [_.deobfuscateDialogDragFile]: "Trascina qui il file dizionario VPAX<br>o cerca nel tuo computer",
        [_.deobfuscateDialogNote]: "Il file dizionario (.dict) è necessario per deoffuscare il file VPAX. Viene utilizzato esclusivamente per questo scopo e non viene mai condiviso, salvato o trasmesso al di fuori di questa applicazione.",
        ...
        [_.errorCheckForUpdates]: "Impossibile controllare gli aggiornamenti - vedere il pannello diagnostica per i dettagli.",
        ...
        [_.errorOperationFailedDetails]: "Si è verificato un errore. Vedere il pannello diagnostica per i dettagli.",
