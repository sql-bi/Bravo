...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Obfuskováno",
        [_.docObfuscatedTooltip]: "Tento dokument byl načten z obfuskovaného souboru VPAX. Kliknutím jej deobfuskujete.",
        [_.deobfuscateDialogTitle]: "Deobfuskovat VPAX",
        [_.deobfuscateDialogDragFile]: "Přetáhněte sem soubor slovníku VPAX<br>nebo ho vyhledejte v počítači",
        [_.deobfuscateDialogNote]: "K deobfuskování souboru VPAX je vyžadován soubor slovníku (.dict). Slouží výhradně k tomuto účelu a není nikdy sdílen, uložen ani přenášen mimo tuto aplikaci.",
        ...
        [_.errorOperationFailedDetails]: "Došlo k chybě. Podrobnosti najdete v panelu diagnostika.",
