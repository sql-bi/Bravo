...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.errorReportConnectionUnsupportedAnalysisServecesCompatibilityMode]: "Režim kompatibility instance Power BI Desktop Analysis Services není Power BI.",
        [_.errorReportConnectionUnsupportedAnalysisServecesConnectionNotFound]: "Připojení TCP služby Power BI Desktop Analysis Services nebylo nalezeno.",
        [_.errorReportConnectionUnsupportedAnalysisServecesProcessNotFound]: "Proces instance služby Power BI Desktop Analysis Services nebyl nalezen.", 
        ...
        [_.errorReportConnectionUnsupportedDatabaseCollectionIsEmpty]: "Instance Power BI Desktop Analysis Services neobsahuje žádné databáze. Zkuste se k sestavě připojit pomocí ikony Bravo v Externích nástrojích Power BI Desktopu.",
        ...
        [_.errorReportConnectionUnsupportedProcessNotYetReady]: "Otevírá se proces Power BI Desktopu nebo instance služby Analysis Services ještě není připravena.", 
        ...
        [_.errorVpaxFileContainsCorruptedData]: "Formát souboru VPAX není platný nebo obsahuje poškozená data.",
