...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Použijte přihlašovací údaje systému",
        [_.optionProxyDefaultCredentialsDescription]: `Použijte výchozí přihlašovací údaje systému k ověření na server proxy. <span class="hl">Tato možnost je vypnuta, vlastní přihlašovací údaje byly uloženy na vašem počítači.</span>`,
