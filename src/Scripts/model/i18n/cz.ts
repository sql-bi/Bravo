...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.helpOptions]: "Možnosti",
        [_.helpUserInterface]: "Uživatelské rozhraní",
        [_.helpTemplates]: "Termíny šablony",
        ...
        [_.manageDatesTemplateNameConfig02]: "Standard - Fiskální",
        [_.manageDatesTemplateNameConfig03]: "Měsíční",
        [_.manageDatesTemplateNameConfig04]: "Měsíční - Fiskální",
        [_.manageDatesTemplateNameConfig05]: "Vlastní",
        [_.manageDatesTemplateNameConfig06]: "Vlastní - Fiskální",
        [_.manageDatesTemplateNameConfig07]: "Týdenní",
        ...
        [_.manageCalendarsTableLabel]: "Tabulka:",
        [_.manageCalendarsAddCalendar]: "Přidat kalendář",
        [_.manageCalendarsTitle]: "Kalendáře",
        [_.manageCalendarsColumnMapping]: "Mapování sloupců",
        [_.manageCalendarsLoadError]: "Chyba při načítání kalendářů tabulky",
        [_.manageCalendarsNoCalendars]: "Pro tuto tabulku nejsou definovány žádné kalendáře",
        [_.manageCalendarsDeleteButton]: "Smazat",
        [_.manageCalendarsColumnName]: "Sloupec",
        [_.manageCalendarsSampleValues]: "Vzorové hodnoty",
        [_.manageCalendarsBlank]: "(prázdné)",
        [_.manageCalendarsUnassigned]: "Nepřiřazeno",
        [_.manageCalendarsDate]: "Datum",
        [_.manageCalendarsYear]: "Rok",
        [_.manageCalendarsSemester]: "Pololetí",
        [_.manageCalendarsSemesterOfYear]: "Pololetí roku",
        [_.manageCalendarsQuarter]: "Čtvrtletí",
        [_.manageCalendarsQuarterOfYear]: "Čtvrtletí roku",
        [_.manageCalendarsQuarterOfSemester]: "Čtvrtletí pololetí",
        [_.manageCalendarsMonth]: "Měsíc",
        [_.manageCalendarsMonthOfYear]: "Měsíc roku",
        [_.manageCalendarsMonthOfSemester]: "Měsíc pololetí",
        [_.manageCalendarsMonthOfQuarter]: "Měsíc čtvrtletí",
        [_.manageCalendarsWeek]: "Týden",
        [_.manageCalendarsWeekOfYear]: "Týden roku",
        [_.manageCalendarsWeekOfSemester]: "Týden pololetí",
        [_.manageCalendarsWeekOfQuarter]: "Týden čtvrtletí",
        [_.manageCalendarsWeekOfMonth]: "Týden měsíce",
        [_.manageCalendarsDayOfYear]: "Den roku",
        [_.manageCalendarsDayOfSemester]: "Den pololetí",
        [_.manageCalendarsDayOfQuarter]: "Den čtvrtletí",
        [_.manageCalendarsDayOfMonth]: "Den měsíce",
        [_.manageCalendarsDayOfWeek]: "Den týdne",
        [_.manageCalendarsTimeRelated]: "Časově související",
        [_.manageCalendarsUpdateSuccess]: "Kalendář byl úspěšně aktualizován",
        [_.manageCalendarsUpdateError]: "Chyba při aktualizaci kalendáře",
        [_.manageCalendarsEnterName]: "Zadejte název kalendáře:",
        [_.manageCalendarsCreateSuccess]: "Kalendář byl úspěšně vytvořen",
        [_.manageCalendarsCreateError]: "Chyba při vytváření kalendáře",
        [_.manageCalendarsConfirmDelete]: "Opravdu chcete odstranit kalendář '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Kalendář byl úspěšně odstraněn",
        [_.manageCalendarsDeleteError]: "Chyba při odstraňování kalendáře",
        [_.manageCalendarsRenameCalendar]: "Přejmenovat",
        [_.manageCalendarsEnterNewName]: "Zadejte nový název kalendáře:",
        [_.manageCalendarsRenameSuccess]: "Kalendář byl úspěšně přejmenován",
        [_.manageCalendarsRenameError]: "Chyba při přejmenování kalendáře",
        [_.manageCalendarsUnknown]: "Neznámý",
        [_.manageCalendarsDeleteCalendar]: "Smazat",
        [_.manageCalendarsSmartCompletion]: "Chytré doplňování",
        [_.manageCalendarsSmartCompletionTooltip]: "Přiřaďte kategorii kalendáře každému nepřiřazenému sloupci na základě kardinality sloupce Rok. Před začátkem přiřaďte Rok ručně.",
        [_.manageCalendarsAcceptAllSuggestions]: "Přijmout všechny návrhy",
        [_.manageCalendarsHideUnassignedColumns]: "Skrýt nepřiřazené sloupce",
        [_.manageCalendarsLegendPrimary]: "Primární",
        [_.manageCalendarsLegendPrimaryTooltip]: "Primární sloupec pro související kategorii",
        [_.manageCalendarsLegendAssociated]: "Přidružený",
        [_.manageCalendarsLegendAssociatedTooltip]: "Přidružený sloupec pro související kategorii",
        [_.manageCalendarsLegendLinked]: "Propojený",
        [_.manageCalendarsLegendLinkedTooltip]: "Implicitně přidružený sloupec pro související kategorii, protože se používá k řazení primárního nebo přidruženého sloupce",
        [_.manageCalendarsColumnHeaderValues]: "# HODNOTY",
        [_.manageCalendarsPromoteTooltip]: "Kliknutím nastavíte jako primární sloupec",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Kliknutím odstraníte přiřazení",
        [_.manageCalendarsImplicitColumnTooltip]: "Implicitně přidružený sloupec pro související kategorii prostřednictvím vztahu SortByColumn. Kliknutím jej nastavíte jako primární sloupec.",
        [_.manageCalendarsCardinalityWarningTooltip]: "Kardinalita {actualCardinality} neodpovídá očekávané hodnotě {expectedCardinality} pro kategorii {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Odstranit primární přiřazení pro {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Povýšit {categoryName} na primární",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Propojený sloupec prostřednictvím SortByColumn pro {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Upozornění na kardinalitu: nalezeno {actualCardinality}, očekáváno {expectedCardinality}",
        [_.manageCalendarsGridAriaLabel]: "Mapování sloupců kalendáře",
        [_.manageCalendarsCellAriaLabel]: "{columnName} pro kalendář {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} aktualizováno na {categoryName}",
