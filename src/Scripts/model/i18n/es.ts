...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Ofuscado",
        [_.docObfuscatedTooltip]: "Este documento se ha cargado desde un archivo VPAX ofuscado. Haga clic para desofuscarlo.",
        [_.deobfuscateDialogTitle]: "Desofuscar VPAX",
        [_.deobfuscateDialogDragFile]: "Arrastre aquí el archivo de diccionario VPAX<br>o búsquelo en su equipo",
        [_.deobfuscateDialogNote]: "El archivo de diccionario (.dict) es necesario para desofuscar el archivo VPAX. Se utiliza exclusivamente para este fin y nunca se comparte, almacena ni transmite fuera de esta aplicación.",
        ...
        [_.errorCheckForUpdates]: "No se pueden buscar actualizaciones - consulte el panel de diagnóstico para más detalles.",
        ...
        [_.errorOperationFailedDetails]: "Se ha producido un error. Consulte el panel de diagnóstico para más detalles.",
