...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Utilice las credenciales del sistema",
        [_.optionProxyDefaultCredentialsDescription]: `Use las credenciales predeterminadas del sistema para autenticar en el servidor proxy. <span class="hl">Esta opción está desactivada, las credenciales personalizadas se han guardado en su computadora.</span>`,
