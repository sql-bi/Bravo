...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devCreateTemplateDialogOk]: "Crear",
        [_.devCreateTemplateLabelModel]: "Residencia en",
        [_.devCreateTemplateLabelName]: "Nombre de la plantilla",
        ...
        [_.devShowInFolder]: "Mostrar en el explorador de archivos",
        ...
        [_.devTemplatesColType]: "Escribe",
        [_.devTemplatesCreate]: "Nueva plantilla",
        [_.devTemplatesEdit]: "Editar",
        [_.devTemplatesEditTitle]: "Editar en el Visual Studio Code",
        [_.devTemplatesEmpty]: "No se encontraron plantillas de citas personalizadas.",
        [_.devTemplatesNotAvailable]: "Esta plantilla no está más disponible.",
        [_.devTemplatesRemove]: "Remover",
        [_.devTemplatesTypeOrganization]: "Organización",
        [_.devTemplatesTypeUser]: "Usuaria",
        [_.devTemplatesVSCodeDownload]: "Descargue Visual Studio Code",
        [_.devTemplatesVSCodeExtensionDownload]: "Descargar {extension}",
        [_.devTemplatesVSCodeMessage]: "<p>El proyecto de plantilla de fecha ahora se abrirá con el Visual Studio Code y requiere la extensión <b>{extension}</b> que se compilará.</p><p>Si aún no está disponible en su sistema, use el enlace a continuación para descargarlos e instalarlos:</p> ",
        [_.devTemplatesVSCodeTitle]: "Abra con Visual Studio Code",
        [_.dialogCancel]: "Cancelar",
        [_.dialogContinue]: "Continuar",
        [_.dialogNeverShowAgain]: "No muestres esto de nuevo",
        [_.dialogOK]: "Ok",
        [_.dialogOpen]: "Abrir",
        [_.docLimited]: "Limitado",
        [_.docLimitedTooltip]: "No todas las características están disponibles para este documento.",
        [_.documentation]: "Documentación",
        ...
        [_.errorPathNotFound]: "Camino no encontrado o no tiene los derechos para abrirlo.",
        ...
        [_.helpOptions]: "Opción",
        [_.helpUserInterface]: "Interfaz de usuario",
        [_.helpTemplates]: "Plantillas de fechas",
        ...
        [_.manageDatesManageTemplates]: "Administrar plantillas",
        ...
        [_.manageDatesTemplateNameConfig02]: "Estándar - Fiscal",
        [_.manageDatesTemplateNameConfig03]: "Mensualmente",
        [_.manageDatesTemplateNameConfig04]: "Mensualmente - Fiscal",
        [_.manageDatesTemplateNameConfig05]: "Personalizado",
        [_.manageDatesTemplateNameConfig06]: "Personalizado - Fiscal",
        [_.manageDatesTemplateNameConfig07]: "Semanal",
        [_.manageDatesTemplateNameCurrent]: "Actual",
        ...
        [_.manageCalendarsTableLabel]: "Tabla:",
        [_.manageCalendarsAddCalendar]: "Agregar Calendario",
        [_.manageCalendarsTitle]: "Calendarios",
        [_.manageCalendarsColumnMapping]: "Mapeo de Columnas",
        [_.manageCalendarsLoadError]: "Error al cargar calendarios de tabla",
        [_.manageCalendarsNoCalendars]: "No hay calendarios definidos para esta tabla",
        [_.manageCalendarsDeleteButton]: "Eliminar",
        [_.manageCalendarsColumnName]: "Columna",
        [_.manageCalendarsSampleValues]: "Valores de Muestra",
        [_.manageCalendarsBlank]: "(vacío)",
        [_.manageCalendarsUnassigned]: "Sin asignar",
        [_.manageCalendarsDate]: "Fecha",
        [_.manageCalendarsYear]: "Año",
        [_.manageCalendarsSemester]: "Semestre",
        [_.manageCalendarsSemesterOfYear]: "Semestre del Año",
        [_.manageCalendarsQuarter]: "Trimestre",
        [_.manageCalendarsQuarterOfYear]: "Trimestre del Año",
        [_.manageCalendarsQuarterOfSemester]: "Trimestre del Semestre",
        [_.manageCalendarsMonth]: "Mes",
        [_.manageCalendarsMonthOfYear]: "Mes del Año",
        [_.manageCalendarsMonthOfSemester]: "Mes del Semestre",
        [_.manageCalendarsMonthOfQuarter]: "Mes del Trimestre",
        [_.manageCalendarsWeek]: "Semana",
        [_.manageCalendarsWeekOfYear]: "Semana del Año",
        [_.manageCalendarsWeekOfSemester]: "Semana del Semestre",
        [_.manageCalendarsWeekOfQuarter]: "Semana del Trimestre",
        [_.manageCalendarsWeekOfMonth]: "Semana del Mes",
        [_.manageCalendarsDayOfYear]: "Día del Año",
        [_.manageCalendarsDayOfSemester]: "Día del Semestre",
        [_.manageCalendarsDayOfQuarter]: "Día del Trimestre",
        [_.manageCalendarsDayOfMonth]: "Día del Mes",
        [_.manageCalendarsDayOfWeek]: "Día de la Semana",
        [_.manageCalendarsTimeRelated]: "Relacionado con Tiempo",
        [_.manageCalendarsUpdateSuccess]: "Calendario actualizado exitosamente",
        [_.manageCalendarsUpdateError]: "Error al actualizar el calendario",
        [_.manageCalendarsEnterName]: "Ingrese el nombre del calendario:",
        [_.manageCalendarsCreateSuccess]: "Calendario creado exitosamente",
        [_.manageCalendarsCreateError]: "Error al crear el calendario",
        [_.manageCalendarsConfirmDelete]: "¿Está seguro de que desea eliminar el calendario '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Calendario eliminado exitosamente",
        [_.manageCalendarsDeleteError]: "Error al eliminar el calendario",
        [_.manageCalendarsRenameCalendar]: "Renombrar",
        [_.manageCalendarsEnterNewName]: "Ingrese el nuevo nombre del calendario:",
        [_.manageCalendarsRenameSuccess]: "Calendario renombrado exitosamente",
        [_.manageCalendarsRenameError]: "Error al renombrar el calendario",
        [_.manageCalendarsUnknown]: "Desconocido",
        [_.manageCalendarsDeleteCalendar]: "Eliminar",
        [_.manageCalendarsSmartCompletion]: "Completado inteligente",
        [_.manageCalendarsSmartCompletionTooltip]: "Asignar categoría de calendario a cada columna no asignada según la cardinalidad de la columna Año. Asigne Año manualmente antes de comenzar.",
        [_.manageCalendarsAcceptAllSuggestions]: "Aceptar todas las sugerencias",
        [_.manageCalendarsHideUnassignedColumns]: "Ocultar columnas no asignadas",
        [_.manageCalendarsLegendPrimary]: "Principal",
        [_.manageCalendarsLegendPrimaryTooltip]: "Columna principal para la categoría relacionada",
        [_.manageCalendarsLegendAssociated]: "Asociada",
        [_.manageCalendarsLegendAssociatedTooltip]: "Columna asociada para la categoría relacionada",
        [_.manageCalendarsLegendLinked]: "Vinculada",
        [_.manageCalendarsLegendLinkedTooltip]: "Columna implícitamente asociada para la categoría relacionada porque se usa para ordenar una columna principal o asociada",
        [_.manageCalendarsColumnHeaderValues]: "# VALORES",
        [_.manageCalendarsPromoteTooltip]: "Haga clic para convertir esta en la columna principal",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Haga clic para eliminar la asignación",
        [_.manageCalendarsImplicitColumnTooltip]: "Columna asociada implícitamente para la categoría relacionada a través de la relación SortByColumn. Haga clic para convertirla en la columna principal.",
        [_.manageCalendarsCardinalityWarningTooltip]: "La cardinalidad de {actualCardinality} no coincide con el valor esperado de {expectedCardinality} para la categoría {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Eliminar asignación principal para {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Promover {categoryName} a principal",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Columna vinculada a través de SortByColumn para {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Advertencia de cardinalidad: {actualCardinality} encontrados, {expectedCardinality} esperados",
        [_.manageCalendarsGridAriaLabel]: "Asignaciones de columnas de calendario",
        [_.manageCalendarsCellAriaLabel]: "{columnName} para calendario {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} actualizado a {categoryName}",
        ...
        [_.optionDev]: "Habilitar plantillas de fecha de usuario",
        ...
        [_.optionResetAlerts]: "Restaurar alertas",
        [_.optionResetAlertsButton]: "Restaurar",
        [_.optionResetAlertsDescription]: "Restaurar todas las alertas ocultas manualmente.",
        [_.optionsDialogAboutMenu]: "Acerca de",
        [_.optionsDialogDevMenu]: "Plantillas",
