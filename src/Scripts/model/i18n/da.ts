...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Brug systemoplysninger",
        [_.optionProxyDefaultCredentialsDescription]: `Brug systemets standardoplysninger til at autentificere til proxyserveren. <span class="hl">det denne mulighed er slukket, brugerdefinerede legitimationsoplysninger er blevet gemt på din computer.</span>`,
