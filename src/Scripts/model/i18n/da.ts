...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Obfuskeret",
        [_.docObfuscatedTooltip]: "Dette dokument er indlæst fra en obfuskeret VPAX-fil. Klik for at deobfuskere det.",
        [_.deobfuscateDialogTitle]: "Deobfuskér VPAX",
        [_.deobfuscateDialogDragFile]: "Træk VPAX-ordbogsfilen hertil<br>eller gennemse din computer",
        [_.deobfuscateDialogNote]: "Ordbogsfilen (.dict) er påkrævet for at deobfuskere VPAX-filen. Den bruges udelukkende til dette formål og deles, gemmes eller overføres aldrig uden for denne applikation.",
