...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devCreateTemplateDialogOk]: "Skab",
        ...
        [_.devShowInFolder]: "Vis i File Explorer",
        ...
        [_.devTemplatesEdit]: "Redigere",
        [_.devTemplatesEditTitle]: "Rediger i Visual Studio Code",
        [_.devTemplatesEmpty]: "Ingen brugerdefinerede dato -skabeloner fundet.",
        [_.devTemplatesNotAvailable]: "Denne skabelon er ikke mere tilgængelig.",
        [_.devTemplatesRemove]: "Fjerne",
        ...
        [_.devTemplatesVSCodeMessage]: "<p>Data -skabelonprojektet åbnes nu med Visual Studio Code og kræver <b>{extension}</b> -udvidelse, der skal udarbejdes.</p> <p>Hvis ikke allerede tilgængelig på dit system, skal du brugeLinket nedenfor for at downloade og installere dem:</p> ",
        [_.devTemplatesVSCodeTitle]: "Åben med Visual Studio Code",
        [_.dialogCancel]: "Annuller",
        [_.dialogContinue]: "Blive ved",
        ...
        [_.helpTemplates]: "Datoer skabeloner",
        ...
        [_.manageDatesTemplateNameConfig04]: "Månedlig - Fiskal",
        [_.manageDatesTemplateNameConfig05]: "Brugerdefineret",
        [_.manageDatesTemplateNameConfig06]: "Brugerdefineret - Fiskal",
        ...
        [_.manageCalendarsAddCalendar]: "Tilføj kalender",
        [_.manageCalendarsTitle]: "Kalendere",
        [_.manageCalendarsColumnMapping]: "Kolonnetilknytning",
        [_.manageCalendarsLoadError]: "Fejl ved indlæsning af tabelkalendere",
        [_.manageCalendarsNoCalendars]: "Ingen kalendere defineret for denne tabel",
        [_.manageCalendarsDeleteButton]: "Slet",
        [_.manageCalendarsColumnName]: "Kolonne",
        [_.manageCalendarsSampleValues]: "Eksempelværdier",
        [_.manageCalendarsBlank]: "(tom)",
        [_.manageCalendarsUnassigned]: "Ikke tildelt",
        [_.manageCalendarsDate]: "Dato",
        [_.manageCalendarsYear]: "År",
        [_.manageCalendarsSemester]: "Halvår",
        [_.manageCalendarsSemesterOfYear]: "Halvår af året",
        [_.manageCalendarsQuarter]: "Kvartal",
        [_.manageCalendarsQuarterOfYear]: "Kvartal af året",
        [_.manageCalendarsQuarterOfSemester]: "Kvartal af halvåret",
        [_.manageCalendarsMonth]: "Måned",
        [_.manageCalendarsMonthOfYear]: "Måned af året",
        [_.manageCalendarsMonthOfSemester]: "Måned af halvåret",
        [_.manageCalendarsMonthOfQuarter]: "Måned af kvartalet",
        [_.manageCalendarsWeek]: "Uge",
        [_.manageCalendarsWeekOfYear]: "Uge af året",
        [_.manageCalendarsWeekOfSemester]: "Uge af halvåret",
        [_.manageCalendarsWeekOfQuarter]: "Uge af kvartalet",
        [_.manageCalendarsWeekOfMonth]: "Uge af måneden",
        [_.manageCalendarsDayOfYear]: "Dag af året",
        [_.manageCalendarsDayOfSemester]: "Dag af halvåret",
        [_.manageCalendarsDayOfQuarter]: "Dag af kvartalet",
        [_.manageCalendarsDayOfMonth]: "Dag af måneden",
        [_.manageCalendarsDayOfWeek]: "Ugedag",
        [_.manageCalendarsTimeRelated]: "Tidsrelateret",
        [_.manageCalendarsUpdateSuccess]: "Kalender opdateret med succes",
        [_.manageCalendarsUpdateError]: "Fejl ved opdatering af kalender",
        [_.manageCalendarsEnterName]: "Indtast kalendernavn:",
        [_.manageCalendarsCreateSuccess]: "Kalender oprettet med succes",
        [_.manageCalendarsCreateError]: "Fejl ved oprettelse af kalender",
        [_.manageCalendarsConfirmDelete]: "Er du sikker på at du vil slette kalenderen '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Kalender slettet med succes",
        [_.manageCalendarsDeleteError]: "Fejl ved sletning af kalender",
        [_.manageCalendarsRenameCalendar]: "Omdøb",
        [_.manageCalendarsEnterNewName]: "Indtast nyt kalendernavn:",
        [_.manageCalendarsRenameSuccess]: "Kalender omdøbt med succes",
        [_.manageCalendarsRenameError]: "Fejl ved omdøbning af kalender",
        [_.manageCalendarsUnknown]: "Ukendt",
        [_.manageCalendarsDeleteCalendar]: "Slet",
        [_.manageCalendarsSmartCompletion]: "Smart udfyldning",
        [_.manageCalendarsSmartCompletionTooltip]: "Tildel kalenderkategori til hver ikke-tildelt kolonne baseret på kardinaliteten af År-kolonnen. Tildel År manuelt før start.",
        [_.manageCalendarsAcceptAllSuggestions]: "Accepter alle forslag",
        [_.manageCalendarsHideUnassignedColumns]: "Skjul ikke-tildelte kolonner",
        [_.manageCalendarsLegendPrimary]: "Primær",
        [_.manageCalendarsLegendPrimaryTooltip]: "Primær kolonne for den relaterede kategori",
        [_.manageCalendarsLegendAssociated]: "Tilknyttet",
        [_.manageCalendarsLegendAssociatedTooltip]: "Tilknyttet kolonne for den relaterede kategori",
        [_.manageCalendarsLegendLinked]: "Linket",
        [_.manageCalendarsLegendLinkedTooltip]: "Implicit tilknyttet kolonne for den relaterede kategori, fordi den bruges til at sortere en primær eller tilknyttet kolonne",
        [_.manageCalendarsColumnHeaderValues]: "# VÆRDIER",
        [_.manageCalendarsPromoteTooltip]: "Klik for at gøre dette til den primære kolonne",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Klik for at fjerne tildeling",
        [_.manageCalendarsImplicitColumnTooltip]: "Implicit tilknyttet kolonne for den relaterede kategori via SortByColumn-relation. Klik for at gøre den til den primære kolonne.",
        [_.manageCalendarsCardinalityWarningTooltip]: "Kardinaliteten af {actualCardinality} matcher ikke den forventede værdi på {expectedCardinality} for kategorien {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Fjern primær tildeling for {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Forfrem {categoryName} til primær",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Linket kolonne via SortByColumn for {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Kardinalitetsadvarsel: {actualCardinality} fundet, {expectedCardinality} forventet",
        [_.manageCalendarsGridAriaLabel]: "Kalenderkolonne-tilknytninger",
        [_.manageCalendarsCellAriaLabel]: "{columnName} for kalender {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} opdateret til {categoryName}",
        ...
        [_.optionDev]: "Aktivér brugerdato skabeloner",
