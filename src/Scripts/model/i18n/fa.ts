...
const locale: Locale = {
	...
	[_.devTemplatesRemove]: "حذف",
        ...
        [_.docObfuscated]: "مبهم‌سازی شده",
        [_.docObfuscatedTooltip]: "این سند از یک فایل VPAX مبهم‌سازی شده بارگذاری شده است. برای رمزگشایی روی آن کلیک کنید.",
        [_.deobfuscateDialogTitle]: "رمزگشایی VPAX",
        [_.deobfuscateDialogDragFile]: "فایل دیکشنری VPAX را اینجا بکشید<br>یا در رایانه خود جستجو کنید",
        [_.deobfuscateDialogNote]: "برای رمزگشایی فایل VPAX، فایل دیکشنری (.dict) الزامی است. این فایل صرفاً برای این منظور استفاده می‌شود و هرگز خارج از این برنامه به اشتراک گذاشته، ذخیره یا منتقل نمی‌شود.",
