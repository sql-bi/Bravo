...
const locale: Locale = {
	...
	[_.devTemplatesRemove]: "حذف",
        ...
        [_.manageCalendarsTableLabel]: "جدول:",
        [_.manageCalendarsAddCalendar]: "افزودن تقویم",
        [_.manageCalendarsTitle]: "تقویم ها",
        [_.manageCalendarsColumnMapping]: "نگاشت ستون",
        [_.manageCalendarsLoadError]: "خطا در بارگیری تقویم های جدول",
        [_.manageCalendarsNoCalendars]: "هیچ تقویمی برای این جدول تعریف نشده است",
        [_.manageCalendarsDeleteButton]: "حذف",
        [_.manageCalendarsColumnName]: "ستون",
        [_.manageCalendarsSampleValues]: "مقادیر نمونه",
        [_.manageCalendarsBlank]: "(خالی)",
        [_.manageCalendarsUnassigned]: "اختصاص داده نشده",
        [_.manageCalendarsDate]: "تاریخ",
        [_.manageCalendarsYear]: "سال",
        [_.manageCalendarsSemester]: "نیمسال",
        [_.manageCalendarsSemesterOfYear]: "نیمسال سال",
        [_.manageCalendarsQuarter]: "فصل",
        [_.manageCalendarsQuarterOfYear]: "فصل سال",
        [_.manageCalendarsQuarterOfSemester]: "فصل نیمسال",
        [_.manageCalendarsMonth]: "ماه",
        [_.manageCalendarsMonthOfYear]: "ماه سال",
        [_.manageCalendarsMonthOfSemester]: "ماه نیمسال",
        [_.manageCalendarsMonthOfQuarter]: "ماه فصل",
        [_.manageCalendarsWeek]: "هفته",
        [_.manageCalendarsWeekOfYear]: "هفته سال",
        [_.manageCalendarsWeekOfSemester]: "هفته نیمسال",
        [_.manageCalendarsWeekOfQuarter]: "هفته فصل",
        [_.manageCalendarsWeekOfMonth]: "هفته ماه",
        [_.manageCalendarsDayOfYear]: "روز سال",
        [_.manageCalendarsDayOfSemester]: "روز نیمسال",
        [_.manageCalendarsDayOfQuarter]: "روز فصل",
        [_.manageCalendarsDayOfMonth]: "روز ماه",
        [_.manageCalendarsDayOfWeek]: "روز هفته",
        [_.manageCalendarsTimeRelated]: "مرتبط با زمان",
        [_.manageCalendarsUpdateSuccess]: "تقویم با موفقیت به‌روزرسانی شد",
        [_.manageCalendarsUpdateError]: "خطا در به‌روزرسانی تقویم",
        [_.manageCalendarsEnterName]: "نام تقویم را وارد کنید:",
        [_.manageCalendarsCreateSuccess]: "تقویم با موفقیت ایجاد شد",
        [_.manageCalendarsCreateError]: "خطا در ایجاد تقویم",
        [_.manageCalendarsConfirmDelete]: "آیا مطمئن هستید که می‌خواهید تقویم '{0}' را حذف کنید؟",
        [_.manageCalendarsDeleteSuccess]: "تقویم با موفقیت حذف شد",
        [_.manageCalendarsDeleteError]: "خطا در حذف تقویم",
        [_.manageCalendarsRenameCalendar]: "تغییر نام",
        [_.manageCalendarsEnterNewName]: "نام جدید تقویم را وارد کنید:",
        [_.manageCalendarsRenameSuccess]: "تقویم با موفقیت تغییر نام یافت",
        [_.manageCalendarsRenameError]: "خطا در تغییر نام تقویم",
        [_.manageCalendarsUnknown]: "ناشناس",
        [_.manageCalendarsDeleteCalendar]: "حذف",
        [_.manageCalendarsSmartCompletion]: "تکمیل هوشمند",
        [_.manageCalendarsSmartCompletionTooltip]: "دسته تقویم را به هر ستون اختصاص نیافته بر اساس کاردینالیتی ستون سال اختصاص دهید. سال را به صورت دستی قبل از شروع اختصاص دهید.",
        [_.manageCalendarsAcceptAllSuggestions]: "پذیرش همه پیشنهادات",
        [_.manageCalendarsHideUnassignedColumns]: "پنهان کردن ستون‌های تخصیص‌نیافته",
        [_.manageCalendarsLegendPrimary]: "اصلی",
        [_.manageCalendarsLegendPrimaryTooltip]: "ستون اصلی برای دسته مربوطه",
        [_.manageCalendarsLegendAssociated]: "مرتبط",
        [_.manageCalendarsLegendAssociatedTooltip]: "ستون مرتبط برای دسته مربوطه",
        [_.manageCalendarsLegendLinked]: "پیوند شده",
        [_.manageCalendarsLegendLinkedTooltip]: "ستون به طور ضمنی مرتبط با دسته مربوطه زیرا برای مرتب‌سازی ستون اصلی یا مرتبط استفاده می‌شود",
        [_.manageCalendarsColumnHeaderValues]: "# مقادیر",
        [_.manageCalendarsPromoteTooltip]: "برای تبدیل این ستون به ستون اصلی کلیک کنید",
        [_.manageCalendarsRemoveAssignmentTooltip]: "برای حذف تخصیص کلیک کنید",
        [_.manageCalendarsImplicitColumnTooltip]: "ستون به طور ضمنی مرتبط با دسته مربوطه از طریق رابطه SortByColumn. برای تبدیل آن به ستون اصلی کلیک کنید.",
        [_.manageCalendarsCardinalityWarningTooltip]: "کاردینالیتی {actualCardinality} با مقدار مورد انتظار {expectedCardinality} برای دسته {categoryName} مطابقت ندارد.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "حذف تخصیص اصلی برای {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "ارتقا {categoryName} به اصلی",
        [_.manageCalendarsLinkedColumnAriaLabel]: "ستون پیوند شده از طریق SortByColumn برای {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "هشدار کاردینالیتی: {actualCardinality} یافت شد، {expectedCardinality} انتظار می‌رفت",
        [_.manageCalendarsGridAriaLabel]: "نگاشت ستون‌های تقویم",
        [_.manageCalendarsCellAriaLabel]: "{columnName} برای تقویم {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} به {categoryName} به‌روزرسانی شد",
