...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.manageDatesDatesTableReferenceDesc]: "This is a hidden table containing all the DAX functions used to generate dates.",
        ...
        [_.manageDatesHolidaysTableDefinitionDesc]: "This is a hidden table containing all the DAX functions used to generate holidays.",
        ...
        [_.ManageCalendars]: "Manage Calendars",
        [_.manageCalendarsTableLabel]: "Table:",
        [_.manageCalendarsAddCalendar]: "Add Calendar",
        [_.manageCalendarsTitle]: "Calendars",
        [_.manageCalendarsColumnMapping]: "Column Mapping",
        [_.manageCalendarsLoadError]: "Failed to load table calendars",
        [_.manageCalendarsNoCalendars]: "No calendars defined for this table",
        [_.manageCalendarsDeleteButton]: "Delete",
        [_.manageCalendarsColumnName]: "Column",
        [_.manageCalendarsSampleValues]: "Sample Values",
        [_.manageCalendarsBlank]: "(blank)",
        [_.manageCalendarsUnassigned]: "Unassigned",
        [_.manageCalendarsDate]: "Date",
        [_.manageCalendarsYear]: "Year",
        [_.manageCalendarsSemester]: "Semester",
        [_.manageCalendarsSemesterOfYear]: "Semester of Year",
        [_.manageCalendarsQuarter]: "Quarter",
        [_.manageCalendarsQuarterOfYear]: "Quarter of Year",
        [_.manageCalendarsQuarterOfSemester]: "Quarter of Semester",
        [_.manageCalendarsMonth]: "Month",
        [_.manageCalendarsMonthOfYear]: "Month of Year",
        [_.manageCalendarsMonthOfSemester]: "Month of Semester",
        [_.manageCalendarsMonthOfQuarter]: "Month of Quarter",
        [_.manageCalendarsWeek]: "Week",
        [_.manageCalendarsWeekOfYear]: "Week of Year",
        [_.manageCalendarsWeekOfSemester]: "Week of Semester",
        [_.manageCalendarsWeekOfQuarter]: "Week of Quarter",
        [_.manageCalendarsWeekOfMonth]: "Week of Month",
        [_.manageCalendarsDayOfYear]: "Day of Year",
        [_.manageCalendarsDayOfSemester]: "Day of Semester",
        [_.manageCalendarsDayOfQuarter]: "Day of Quarter",
        [_.manageCalendarsDayOfMonth]: "Day of Month",
        [_.manageCalendarsDayOfWeek]: "Day of Week",
        [_.manageCalendarsTimeRelated]: "Time Related",
        [_.manageCalendarsUpdateSuccess]: "Calendar updated successfully",
        [_.manageCalendarsUpdateError]: "Failed to update calendar",
        [_.manageCalendarsEnterName]: "Enter calendar name:",
        [_.manageCalendarsCreateSuccess]: "Calendar created successfully",
        [_.manageCalendarsCreateError]: "Failed to create calendar",
        [_.manageCalendarsConfirmDelete]: "Are you sure you want to delete the calendar '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Calendar deleted successfully",
        [_.manageCalendarsDeleteError]: "Failed to delete calendar",
        [_.manageCalendarsRenameCalendar]: "Rename",
        [_.manageCalendarsEnterNewName]: "Enter new calendar name:",
        [_.manageCalendarsRenameSuccess]: "Calendar renamed successfully",
        [_.manageCalendarsRenameError]: "Failed to rename calendar",
        [_.manageCalendarsUnknown]: "Unknown",
        [_.manageCalendarsDeleteCalendar]: "Delete",
        [_.manageCalendarsSmartCompletion]: "Smart completion",
        [_.manageCalendarsSmartCompletionTooltip]: "Assign calendar category to each column that is not assigned based on the cardinality of the Year column. Assign Year manually before starting.",
        [_.manageCalendarsAcceptAllSuggestions]: "Accept all suggestions",
        [_.manageCalendarsHideUnassignedColumns]: "Hide unassigned columns",
        [_.manageCalendarsLegendPrimary]: "Primary",
        [_.manageCalendarsLegendPrimaryTooltip]: "Primary column for the related category",
        [_.manageCalendarsLegendAssociated]: "Associated",
        [_.manageCalendarsLegendAssociatedTooltip]: "Associated column for the related category",
        [_.manageCalendarsLegendLinked]: "Linked",
        [_.manageCalendarsLegendLinkedTooltip]: "Implicitly associated column for the related category because it is used to sort a primary or associated column",
        [_.manageCalendarsColumnHeaderValues]: "# VALUES",
        [_.manageCalendarsPromoteTooltip]: "Click to make this the primary column",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Click to remove assignment",
        [_.manageCalendarsImplicitColumnTooltip]: "Implicitly associated column for the related category via SortByColumn relationship. Click to make it the primary column.",
        [_.manageCalendarsCardinalityWarningTooltip]: "The cardinality of {actualCardinality} does not match the expected value of {expectedCardinality} for category {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Remove primary assignment for {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Promote {categoryName} to primary",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Linked column via SortByColumn for {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Cardinality warning: {actualCardinality} found, expected {expectedCardinality}",
        [_.manageCalendarsGridAriaLabel]: "Calendar column mappings",
        [_.manageCalendarsCellAriaLabel]: "{columnName} for calendar {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} updated to {categoryName}",
        ...
        [_.sceneUnsupportedReasonManageCalendarsIncompatibleDatabaseVersion]: "This feature requires compatibility level 1701 or above.",
        [_.sceneUnsupportedReasonManageCalendarsPBIDesktopModelOnly]: "This feature is supported only by models in Power BI Desktop mode.",
