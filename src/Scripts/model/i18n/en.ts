...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Obfuscated",
        [_.docObfuscatedTooltip]: "This document has been loaded from an obfuscated VPAX file. Click to deobfuscate it.",
        [_.deobfuscateDialogTitle]: "Deobfuscate VPAX",
        [_.deobfuscateDialogDragFile]: "Drag the VPAX dictionary file here<br>or browse your computer",
        [_.deobfuscateDialogNote]: "The dictionary file (.dict) is required to deobfuscate the VPAX file. It is used strictly for this purpose and is never shared, stored, or transmitted outside this application.",
        ...
        [_.errorCheckForUpdates]: "Unable to check for updates - see the diagnostics pane for details.",
        ...
        [_.errorVpaxObfuscationError]: "An error occurred while obfuscating the VPAX file.",
        [_.errorVpaxDeobfuscationError]: "An error occurred while deobfuscating the VPAX file.",
