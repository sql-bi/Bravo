...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Use System Credentials",
        [_.optionProxyDefaultCredentialsDescription]: `Use the system default credentials to authenticate to the proxy server. <span class="hl">It this option is turned off, custom credentials have been saved on your computer.</span>`,
