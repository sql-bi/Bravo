...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devCreateTemplateTitle]: "新自定义模板",
        [_.devDefaultTemplateName]: "无标题",
        [_.devShowInFolder]: "在文件资源管理器中显示",
        ...
        [_.manageDatesCalendarTemplateName]: "模板",
        ...
        [_.manageDatesManageTemplates]: "管理模板",
        ...
        [_.manageDatesTemplateNameConfig02]: "标准模板 - 财政",
        [_.manageDatesTemplateNameConfig03]: "月模板",
        [_.manageDatesTemplateNameConfig04]: "月模板 - 财政",
        [_.manageDatesTemplateNameConfig05]: "自定义",
        [_.manageDatesTemplateNameConfig06]: "自定义 - 财政",
        [_.manageDatesTemplateNameConfig07]: "周模板",
        ...
        [_.manageCalendarsTableLabel]: "表:",
        [_.manageCalendarsAddCalendar]: "添加日历",
        [_.manageCalendarsTitle]: "日历",
        [_.manageCalendarsColumnMapping]: "列映射",
        [_.manageCalendarsLoadError]: "加载表日历时出错",
        [_.manageCalendarsNoCalendars]: "没有为此表定义日历",
        [_.manageCalendarsDeleteButton]: "删除",
        [_.manageCalendarsColumnName]: "列",
        [_.manageCalendarsSampleValues]: "示例值",
        [_.manageCalendarsBlank]: "(空白)",
        [_.manageCalendarsUnassigned]: "未分配",
        [_.manageCalendarsDate]: "日期",
        [_.manageCalendarsYear]: "年",
        [_.manageCalendarsSemester]: "学期",
        [_.manageCalendarsSemesterOfYear]: "年学期",
        [_.manageCalendarsQuarter]: "季度",
        [_.manageCalendarsQuarterOfYear]: "年季度",
        [_.manageCalendarsQuarterOfSemester]: "学期季度",
        [_.manageCalendarsMonth]: "月",
        [_.manageCalendarsMonthOfYear]: "年月",
        [_.manageCalendarsMonthOfSemester]: "学期月",
        [_.manageCalendarsMonthOfQuarter]: "季度月",
        [_.manageCalendarsWeek]: "周",
        [_.manageCalendarsWeekOfYear]: "年周",
        [_.manageCalendarsWeekOfSemester]: "学期周",
        [_.manageCalendarsWeekOfQuarter]: "季度周",
        [_.manageCalendarsWeekOfMonth]: "月周",
        [_.manageCalendarsDayOfYear]: "年日",
        [_.manageCalendarsDayOfSemester]: "学期日",
        [_.manageCalendarsDayOfQuarter]: "季度日",
        [_.manageCalendarsDayOfMonth]: "月日",
        [_.manageCalendarsDayOfWeek]: "周日",
        [_.manageCalendarsTimeRelated]: "时间相关",
        [_.manageCalendarsUpdateSuccess]: "日历更新成功",
        [_.manageCalendarsUpdateError]: "更新日历时出错",
        [_.manageCalendarsEnterName]: "输入日历名称:",
        [_.manageCalendarsCreateSuccess]: "日历创建成功",
        [_.manageCalendarsCreateError]: "创建日历时出错",
        [_.manageCalendarsConfirmDelete]: "您确定要删除日历 '{0}' 吗?",
        [_.manageCalendarsDeleteSuccess]: "日历删除成功",
        [_.manageCalendarsDeleteError]: "删除日历时出错",
        [_.manageCalendarsRenameCalendar]: "重命名",
        [_.manageCalendarsEnterNewName]: "输入新日历名称:",
        [_.manageCalendarsRenameSuccess]: "日历重命名成功",
        [_.manageCalendarsRenameError]: "重命名日历时出错",
        [_.manageCalendarsUnknown]: "未知",
        [_.manageCalendarsDeleteCalendar]: "删除",
        [_.manageCalendarsSmartCompletion]: "智能填充",
        [_.manageCalendarsSmartCompletionTooltip]: "根据年份列的基数为每个未分配的列分配日历类别。在开始之前手动分配年份。",
        [_.manageCalendarsAcceptAllSuggestions]: "接受所有建议",
        [_.manageCalendarsHideUnassignedColumns]: "隐藏未分配的列",
        [_.manageCalendarsLegendPrimary]: "主列",
        [_.manageCalendarsLegendPrimaryTooltip]: "相关类别的主列",
        [_.manageCalendarsLegendAssociated]: "关联列",
        [_.manageCalendarsLegendAssociatedTooltip]: "相关类别的关联列",
        [_.manageCalendarsLegendLinked]: "链接列",
        [_.manageCalendarsLegendLinkedTooltip]: "相关类别的隐式关联列，因为它用于排序主列或关联列",
        [_.manageCalendarsColumnHeaderValues]: "# 值",
        [_.manageCalendarsPromoteTooltip]: "单击使其成为主列",
        [_.manageCalendarsRemoveAssignmentTooltip]: "单击以删除分配",
        [_.manageCalendarsImplicitColumnTooltip]: "通过 SortByColumn 关系隐式关联到相关类别的列。单击使其成为主列。",
        [_.manageCalendarsCardinalityWarningTooltip]: "{actualCardinality} 的基数与类别 {categoryName} 的预期值 {expectedCardinality} 不匹配。",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "删除 {categoryName} 的主要分配",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "将 {categoryName} 提升为主要",
        [_.manageCalendarsLinkedColumnAriaLabel]: "通过 SortByColumn 链接的 {categoryName} 列",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "基数警告：找到 {actualCardinality}，预期 {expectedCardinality}",
        [_.manageCalendarsGridAriaLabel]: "日历列映射",
        [_.manageCalendarsCellAriaLabel]: "日历 {calendarName} 的 {columnName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} 已更新为 {categoryName}",
