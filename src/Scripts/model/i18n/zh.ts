...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "已混淆",
        [_.docObfuscatedTooltip]: "此文档已从混淆的 VPAX 文件加载。单击以取消混淆。",
        [_.deobfuscateDialogTitle]: "取消混淆 VPAX",
        [_.deobfuscateDialogDragFile]: "将 VPAX 字典文件拖到此处<br>或在计算机上浏览",
        [_.deobfuscateDialogNote]: "需要字典文件 (.dict) 才能取消混淆 VPAX 文件。该文件仅用于此目的，绝不会在此应用程序之外共享、存储或传输。",
        [_.documentation]: "文档",
        [_.doneCtrlTitle]: "完成",
        [_.emailAddress]: "电子邮件",
