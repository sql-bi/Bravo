...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.errorReportConnectionUnsupportedAnalysisServecesCompatibilityMode]: "Power BI Desktop Analysis Services 实例的兼容模式不是 PowerBI.",
        [_.errorReportConnectionUnsupportedAnalysisServecesConnectionNotFound]: "未找到Power BI Desktop Analysis Services的TCP连接",
        [_.errorReportConnectionUnsupportedAnalysisServecesProcessNotFound]: "未找到Power BI Desktop Analysis Services 实例的进程", 
        [_.errorReportConnectionUnsupportedConnectionException]: "Power BI Desktop Analysis Services 实例连接异常",
        [_.errorReportConnectionUnsupportedDatabaseCollectionIsEmpty]: "Power BI Desktop Analysis Services 实例不包含任何数据库。 请尝试通过Power BI Desktop的 外部工具 选项卡下的Bravo图标连接到报告。",
        ...
        [_.errorReportConnectionUnsupportedProcessNotYetReady]: "Power BI Desktop进程正在打开, 或者Analysis Services实例尚未准备好。", 
        ...
        [_.errorVpaxFileContainsCorruptedData]: "VPAX 文件格式无效或包含损坏的数据",
        ...
        [_.manageDatesYearRangeDesc]: "为您的模型定义一个时间区间. 如果不填 <em>起始年份</em> 和/or <em>结束年份</em> 就会应用自动扫描的结果",
