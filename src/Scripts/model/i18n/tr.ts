...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Gizlenmiş",
        [_.docObfuscatedTooltip]: "Bu belge, gizlenmiş bir VPAX dosyasından yüklendi. Gizlemeyi kaldırmak için tıklayın.",
        [_.deobfuscateDialogTitle]: "VPAX Gizlemesini Kaldır",
        [_.deobfuscateDialogDragFile]: "VPAX sözlük dosyasını buraya sürükleyin<br>veya bilgisayarınızda arayın",
        [_.deobfuscateDialogNote]: "VPAX dosyasının gizlemesini kaldırmak için sözlük dosyası (.dict) gereklidir. Yalnızca bu amaç için kullanılır ve bu uygulamanın dışında hiçbir zaman paylaşılmaz, depolanmaz veya iletilmez.",
