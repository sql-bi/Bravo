...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devCreateTemplateDialogOk]: "Oluşturmak",
        [_.devCreateTemplateLabelModel]: "Dayalı",
        [_.devCreateTemplateLabelName]: "Şablon adı",
        ...
        [_.devShowInFolder]: "Dosya Gezgini'nde Göster",
        ...
        [_.devTemplatesColType]: "Tip",
        [_.devTemplatesCreate]: "Yeni şablon",
        [_.devTemplatesEdit]: "Düzenlemek",
        [_.devTemplatesEditTitle]: "Visual Studio Code Düzenle",
        [_.devTemplatesEmpty]: "Özel tarih şablonu bulunamadı.",
        [_.devTemplatesNotAvailable]: "Bu şablon daha mevcut değil.",
        [_.devTemplatesRemove]: "Kaldırmak",
        [_.devTemplatesTypeOrganization]: "Organizasyon",
        [_.devTemplatesTypeUser]: "Kullanıcı",
        [_.devTemplatesVSCodeDownload]: "İndir Visual Studio Code",
        [_.devTemplatesVSCodeExtensionDownload]: "İndir {extension}",
        [_.devTemplatesVSCodeMessage]: "<p>Tarih şablonu projesi artık Visual Studio Code ile açılacak ve <b>{extension}</b> uzantısının derlenmesini gerektiriyor. </p><p>Sisteminizde zaten mevcut değilse, kullanınİndirip yüklemek için aşağıdaki bağlantı:</p> ",
        [_.devTemplatesVSCodeTitle]: "Visual Studio Code ile Aç",
        [_.dialogCancel]: "İptal",
        [_.dialogContinue]: "Devam et",
        [_.dialogNeverShowAgain]: "Bunu bir daha gösterme",
        [_.dialogOK]: "Tamam",
        [_.dialogOpen]: "Aç",
        [_.docLimited]: "Kısıtlı",
        [_.docLimitedTooltip]: "Bu belge için tüm özellikler mevcut değildir.",
        [_.documentation]: "Belgeler",
        ...
        [_.errorReportConnectionUnsupportedAnalysisServicesConnectionNotFound]: "Power BI Desktop Analysis Services TCP bağlantısı bulunamadı.",
        [_.errorReportConnectionUnsupportedAnalysisServicesProcessNotFound]: "Power BI Desktop Analysis Services işlemi bulunamadı.",
        ...
        [_.errorReportConnectionUnsupportedDatabaseCollectionEmpty]: "Power BI Desktop Analysis Services herhangi bir veritabanı içermiyor. Power BI Desktop'un Yardımcı Araçları'ndaki Bravo simgesini kullanarak rapora bağlanmayı deneyin.",
        ...
        [_.errorReportConnectionUnsupportedProcessNotReady]: "Power BI Desktop açılıyor veya Analysis Services henüz hazır değil.",
        ...
        [_.helpOptions]: "Seçenekler",
        [_.helpUserInterface]: "Kullanıcı arayüzü",
        [_.helpTemplates]: "Tarihler Şablonlar",
        ...
        [_.manageDatesManageTemplates]: "Şablonları yönetin",
        ...
        [_.manageDatesTemplateNameConfig02]: "Standart - Mali",
        [_.manageDatesTemplateNameConfig03]: "Aylık",
        [_.manageDatesTemplateNameConfig04]: "Aylık - Mali",
        [_.manageDatesTemplateNameConfig05]: "Özel",
        [_.manageDatesTemplateNameConfig06]: "Özel - Mali",
        [_.manageDatesTemplateNameConfig07]: "Haftalık",
        ...
        [_.manageCalendarsTableLabel]: "Tablo:",
        [_.manageCalendarsAddCalendar]: "Takvim ekle",
        [_.manageCalendarsTitle]: "Takvimler",
        [_.manageCalendarsColumnMapping]: "Sütun eşleştirme",
        [_.manageCalendarsLoadError]: "Tablo takvimleri yüklenirken hata",
        [_.manageCalendarsNoCalendars]: "Bu tablo için tanımlanmış takvim yok",
        [_.manageCalendarsDeleteButton]: "Sil",
        [_.manageCalendarsColumnName]: "Sütun",
        [_.manageCalendarsSampleValues]: "Örnek değerler",
        [_.manageCalendarsBlank]: "(boş)",
        [_.manageCalendarsUnassigned]: "Atanmamış",
        [_.manageCalendarsDate]: "Tarih",
        [_.manageCalendarsYear]: "Yıl",
        [_.manageCalendarsSemester]: "Yarıyıl",
        [_.manageCalendarsSemesterOfYear]: "Yılın yarıyılı",
        [_.manageCalendarsQuarter]: "Çeyrek",
        [_.manageCalendarsQuarterOfYear]: "Yılın çeyreği",
        [_.manageCalendarsQuarterOfSemester]: "Yarıyılın çeyreği",
        [_.manageCalendarsMonth]: "Ay",
        [_.manageCalendarsMonthOfYear]: "Yılın ayı",
        [_.manageCalendarsMonthOfSemester]: "Yarıyılın ayı",
        [_.manageCalendarsMonthOfQuarter]: "Çeyreğin ayı",
        [_.manageCalendarsWeek]: "Hafta",
        [_.manageCalendarsWeekOfYear]: "Yılın haftası",
        [_.manageCalendarsWeekOfSemester]: "Yarıyılın haftası",
        [_.manageCalendarsWeekOfQuarter]: "Çeyreğin haftası",
        [_.manageCalendarsWeekOfMonth]: "Ayın haftası",
        [_.manageCalendarsDayOfYear]: "Yılın günü",
        [_.manageCalendarsDayOfSemester]: "Yarıyılın günü",
        [_.manageCalendarsDayOfQuarter]: "Çeyreğin günü",
        [_.manageCalendarsDayOfMonth]: "Ayın günü",
        [_.manageCalendarsDayOfWeek]: "Haftanın günü",
        [_.manageCalendarsTimeRelated]: "Zamanla ilgili",
        [_.manageCalendarsUpdateSuccess]: "Takvim başarıyla güncellendi",
        [_.manageCalendarsUpdateError]: "Takvim güncellenirken hata",
        [_.manageCalendarsEnterName]: "Takvim adını girin:",
        [_.manageCalendarsCreateSuccess]: "Takvim başarıyla oluşturuldu",
        [_.manageCalendarsCreateError]: "Takvim oluşturulurken hata",
        [_.manageCalendarsConfirmDelete]: "'{0}' takvimini silmek istediğinizden emin misiniz?",
        [_.manageCalendarsDeleteSuccess]: "Takvim başarıyla silindi",
        [_.manageCalendarsDeleteError]: "Takvim silinirken hata",
        [_.manageCalendarsRenameCalendar]: "Yeniden adlandır",
        [_.manageCalendarsEnterNewName]: "Yeni takvim adını girin:",
        [_.manageCalendarsRenameSuccess]: "Takvim başarıyla yeniden adlandırıldı",
        [_.manageCalendarsRenameError]: "Takvim yeniden adlandırılırken hata",
        [_.manageCalendarsUnknown]: "Bilinmiyor",
        [_.manageCalendarsDeleteCalendar]: "Sil",
        [_.manageCalendarsSmartCompletion]: "Akıllı tamamlama",
        [_.manageCalendarsSmartCompletionTooltip]: "Yıl sütununun kardinalitesine göre atanmamış her sütuna takvim kategorisi atayın. Başlamadan önce Yıl'ı manuel olarak atayın.",
        [_.manageCalendarsAcceptAllSuggestions]: "Tüm önerileri kabul et",
        [_.manageCalendarsHideUnassignedColumns]: "Atanmamış sütunları gizle",
        [_.manageCalendarsLegendPrimary]: "Birincil",
        [_.manageCalendarsLegendPrimaryTooltip]: "İlgili kategori için birincil sütun",
        [_.manageCalendarsLegendAssociated]: "İlişkili",
        [_.manageCalendarsLegendAssociatedTooltip]: "İlgili kategori için ilişkili sütun",
        [_.manageCalendarsLegendLinked]: "Bağlantılı",
        [_.manageCalendarsLegendLinkedTooltip]: "Birincil veya ilişkili bir sütunu sıralamak için kullanıldığından ilgili kategori için dolaylı olarak ilişkili sütun",
        [_.manageCalendarsColumnHeaderValues]: "# DEĞERLER",
        [_.manageCalendarsPromoteTooltip]: "Bunu birincil sütun yapmak için tıklayın",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Atamayı kaldırmak için tıklayın",
        [_.manageCalendarsImplicitColumnTooltip]: "SortByColumn ilişkisi aracılığıyla ilgili kategori için dolaylı olarak ilişkili sütun. Birincil sütun yapmak için tıklayın.",
        [_.manageCalendarsCardinalityWarningTooltip]: "{actualCardinality} kardinalitesi, {categoryName} kategorisi için beklenen {expectedCardinality} değeriyle eşleşmiyor.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "{categoryName} için birincil atamayı kaldır",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "{categoryName} birincil sütuna yükselt",
        [_.manageCalendarsLinkedColumnAriaLabel]: "{categoryName} için SortByColumn aracılığıyla bağlantılı sütun",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Kardinalite uyarısı: {actualCardinality} bulundu, {expectedCardinality} bekleniyordu",
        [_.manageCalendarsGridAriaLabel]: "Takvim sütunu eşlemeleri",
        [_.manageCalendarsCellAriaLabel]: "{calendarName} takvimi için {columnName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName}, {categoryName} olarak güncellendi",
        ...
        [_.optionDev]: "Kullanıcı Tarihi Şablonlarını Etkinleştir",
        ...
        [_.optionInvalidValue]: "Geçersiz değer",
        ...
        [_.optionPolicyNotice]: "Bu seçenek kuruluşunuz tarafından yönetiliyor.",
        ...
        [_.optionProxyBypassListDescription]: "Eklenen girişlerle başlayan adresler dışında proxy sunucusunu kullanın.Girişleri ayırmak için noktalı virgül (;) kullanın.",
        [_.optionProxyBypassOnLocal]: "Yerel adresleri atlayın",
        [_.optionProxyBypassOnLocalDescription]: "Proxy'yi yerel (intranet) adreslerle kullanmayın.",
        [_.optionProxyConfirmDeleteCredentials]: "Özel kimlik bilgilerini sistemden kaldıracağınızdan emin misiniz?",
        [_.optionProxyCustomCredentials]: "Özel kimlik bilgileri",
        [_.optionProxyCustomCredentialsDescription]: "Proxy sunucusuna doğrulamak için özel kimlik bilgilerini kullanın.Sistem kimlik bilgilerini kullanmak için bırakın.",
        [_.optionProxyCustomCredentialsEdit]: "Özel Kimlik Bilgilerini Düzenle",
        [_.optionProxyType]: "Proxy sunucu",
        [_.optionProxyTypeCustom]: "Gelenek",
        [_.optionProxyTypeDescription]: "Bir proxy sunucusu seçin.",
        [_.optionProxyTypeNone]: "Hiçbiri",
        [_.optionProxyTypeSystem]: "Sistem",
        [_.optionResetAlerts]: "Uyarıları Geri Yükle",
        [_.optionResetAlertsButton]: "Eski haline getirmek",
        [_.optionResetAlertsDescription]: "Tüm manuel gizli uyarıları geri yükleyin.",
        [_.optionsDialogAboutMenu]: "Hakkında",
        [_.optionsDialogDevMenu]: "Şablonlar",
        [_.optionsDialogFormattingMenu]: "Biçimlendirme",
        [_.optionsDialogGeneralMenu]: "Genel",
        [_.optionsDialogProxyMenu]: "Vekil",
