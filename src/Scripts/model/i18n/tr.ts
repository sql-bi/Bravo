...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Sistem kimlik bilgilerini kullanın",
        [_.optionProxyDefaultCredentialsDescription]: `Proxy sunucusuna kimlik doğrulamak için sistem varsayılan kimlik bilgilerini kullanın. <span class="hl">Bu seçenek kapatıldı, bilgisayarınızda özel kimlik bilgileri kaydedildi.</span>`,
