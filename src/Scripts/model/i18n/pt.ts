...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devTemplatesVSCodeMessage]: "<p> O projeto do modelo de data agora será aberto com o Visual Studio Code e requer a extensão <b>{extension}</b> a ser compilada. </p> <p> Se ainda não estiver disponível no seu sistema, useO link abaixo para baixar e instalá -los: </p> ",
        ...
        [_.exportDataTruncated]: "Esta tabela tem muitas linhas.Somente os primeiros milhões de linhas podem ser exportadas para o Excel.Use o formato CSV para exportar todas as linhas da tabela.",
        ...
        [_.optionProxyBypassListDescription]: "Use o servidor proxy, exceto para endereços que começam com as entradas inseridas.Use semicolons (;) para separar entradas.",
