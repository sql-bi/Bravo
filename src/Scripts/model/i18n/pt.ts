...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentialsDescription]: `Use as credenciais padrão do sistema para autenticar para o servidor proxy. <span class="hl">Essa opção está desligada, credenciais personalizadas foram salvas no seu computador.</span>`,
