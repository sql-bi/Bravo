...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscatedTooltip]: "Este documento foi carregado a partir de um ficheiro VPAX ofuscado. Clique para desofuscá-lo.",
        [_.deobfuscateDialogTitle]: "Desofuscar VPAX",
        [_.deobfuscateDialogDragFile]: "Arraste o ficheiro de dicionário VPAX para aqui<br>ou procure no seu computador",
        [_.deobfuscateDialogNote]: "O ficheiro de dicionário (.dict) é necessário para desofuscar o ficheiro VPAX. É utilizado exclusivamente para este fim e nunca é partilhado, armazenado ou transmitido fora desta aplicação.",
