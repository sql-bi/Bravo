...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devShowInFolder]: "Mostrar no File Explorer",
        ...
        [_.manageCalendarsAddCalendar]: "Adicionar Calendário",
        [_.manageCalendarsTitle]: "Calendários",
        [_.manageCalendarsColumnMapping]: "Mapeamento de Colunas",
        [_.manageCalendarsLoadError]: "Falha ao carregar calendários da tabela",
        [_.manageCalendarsNoCalendars]: "Nenhum calendário definido para esta tabela",
        [_.manageCalendarsDeleteButton]: "Excluir",
        [_.manageCalendarsColumnName]: "Coluna",
        [_.manageCalendarsSampleValues]: "Valores de Exemplo",
        [_.manageCalendarsBlank]: "(vazio)",
        [_.manageCalendarsUnassigned]: "Não atribuído",
        [_.manageCalendarsDate]: "Data",
        [_.manageCalendarsYear]: "Ano",
        [_.manageCalendarsSemester]: "Semestre",
        [_.manageCalendarsSemesterOfYear]: "Semestre do Ano",
        [_.manageCalendarsQuarter]: "Trimestre",
        [_.manageCalendarsQuarterOfYear]: "Trimestre do Ano",
        [_.manageCalendarsQuarterOfSemester]: "Trimestre do Semestre",
        [_.manageCalendarsMonth]: "Mês",
        [_.manageCalendarsMonthOfYear]: "Mês do Ano",
        [_.manageCalendarsMonthOfSemester]: "Mês do Semestre",
        [_.manageCalendarsMonthOfQuarter]: "Mês do Trimestre",
        [_.manageCalendarsWeek]: "Semana",
        [_.manageCalendarsWeekOfYear]: "Semana do Ano",
        [_.manageCalendarsWeekOfSemester]: "Semana do Semestre",
        [_.manageCalendarsWeekOfQuarter]: "Semana do Trimestre",
        [_.manageCalendarsWeekOfMonth]: "Semana do Mês",
        [_.manageCalendarsDayOfYear]: "Dia do Ano",
        [_.manageCalendarsDayOfSemester]: "Dia do Semestre",
        [_.manageCalendarsDayOfQuarter]: "Dia do Trimestre",
        [_.manageCalendarsDayOfMonth]: "Dia do Mês",
        [_.manageCalendarsDayOfWeek]: "Dia da Semana",
        [_.manageCalendarsTimeRelated]: "Relacionado ao Tempo",
        [_.manageCalendarsUpdateSuccess]: "Calendário atualizado com sucesso",
        [_.manageCalendarsUpdateError]: "Falha ao atualizar calendário",
        [_.manageCalendarsEnterName]: "Digite o nome do calendário:",
        [_.manageCalendarsCreateSuccess]: "Calendário criado com sucesso",
        [_.manageCalendarsCreateError]: "Falha ao criar calendário",
        [_.manageCalendarsConfirmDelete]: "Tem certeza de que deseja excluir o calendário '{0}'?",
        [_.manageCalendarsDeleteSuccess]: "Calendário excluído com sucesso",
        [_.manageCalendarsDeleteError]: "Falha ao excluir calendário",
        [_.manageCalendarsRenameCalendar]: "Renomear",
        [_.manageCalendarsEnterNewName]: "Digite o novo nome do calendário:",
        [_.manageCalendarsRenameSuccess]: "Calendário renomeado com sucesso",
        [_.manageCalendarsRenameError]: "Falha ao renomear calendário",
        [_.manageCalendarsUnknown]: "Desconhecido",
        [_.manageCalendarsDeleteCalendar]: "Excluir",
        [_.manageCalendarsSmartCompletion]: "Preenchimento inteligente",
        [_.manageCalendarsSmartCompletionTooltip]: "Atribuir categoria de calendário a cada coluna não atribuída com base na cardinalidade da coluna Ano. Atribua Ano manualmente antes de começar.",
        [_.manageCalendarsAcceptAllSuggestions]: "Aceitar todas as sugestões",
        [_.manageCalendarsHideUnassignedColumns]: "Ocultar colunas não atribuídas",
        [_.manageCalendarsLegendPrimary]: "Principal",
        [_.manageCalendarsLegendPrimaryTooltip]: "Coluna principal para a categoria relacionada",
        [_.manageCalendarsLegendAssociated]: "Associada",
        [_.manageCalendarsLegendAssociatedTooltip]: "Coluna associada para a categoria relacionada",
        [_.manageCalendarsLegendLinked]: "Vinculada",
        [_.manageCalendarsLegendLinkedTooltip]: "Coluna implicitamente associada para a categoria relacionada porque é usada para ordenar uma coluna principal ou associada",
        [_.manageCalendarsColumnHeaderValues]: "# VALORES",
        [_.manageCalendarsPromoteTooltip]: "Clique para tornar esta a coluna principal",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Clique para remover atribuição",
        [_.manageCalendarsImplicitColumnTooltip]: "Coluna implicitamente associada para a categoria relacionada via relacionamento SortByColumn. Clique para torná-la a coluna principal.",
        [_.manageCalendarsCardinalityWarningTooltip]: "A cardinalidade de {actualCardinality} não corresponde ao valor esperado de {expectedCardinality} para a categoria {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Remover atribuição principal para {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Promover {categoryName} para principal",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Coluna vinculada via SortByColumn para {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Aviso de cardinalidade: {actualCardinality} encontrado, {expectedCardinality} esperado",
        [_.manageCalendarsGridAriaLabel]: "Mapeamentos de colunas de calendário",
        [_.manageCalendarsCellAriaLabel]: "{columnName} para calendário {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} atualizado para {categoryName}",
