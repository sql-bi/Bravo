...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.devCreateTemplateDialogOk]: "Δημιουργώ",
        [_.devCreateTemplateLabelModel]: "Βασισμένο στο",
        [_.devCreateTemplateLabelName]: "Όνομα προτύπου",
        ...
        [_.devShowInFolder]: "Εμφάνιση στο File Explorer",
        ...
        [_.devTemplatesColType]: "Τύπος",
        [_.devTemplatesCreate]: "Νέο πρότυπο",
        [_.devTemplatesEdit]: "Επεξεργασία",
        [_.devTemplatesEditTitle]: "Επεξεργασία στον Visual Studio Code",
        [_.devTemplatesEmpty]: "Δεν βρέθηκαν πρότυπα προσαρμοσμένης ημερομηνίας.",
        [_.devTemplatesNotAvailable]: "Αυτό το πρότυπο δεν είναι πιο διαθέσιμο.",
        [_.devTemplatesRemove]: "Αφαιρώ",
        [_.devTemplatesTypeOrganization]: "Οργάνωση",
        [_.devTemplatesTypeUser]: "Χρήστης",
        [_.devTemplatesVSCodeDownload]: "Κατεβάστε τον Visual Studio Code",
        [_.devTemplatesVSCodeExtensionDownload]: "Λήψη {extension}",
        [_.devTemplatesVSCodeMessage]: "<p>Το έργο προτύπου ημερομηνίας θα ανοίξει τώρα με τον Visual Studio Code και απαιτεί την {extension}</p><p>αν δεν είναι ήδη διαθέσιμο στο σύστημά σας, χρησιμοποιήστεΟ παρακάτω σύνδεσμος για να τα κατεβάσετε και να τα εγκαταστήσετε:</p> ",
        [_.devTemplatesVSCodeTitle]: "Ανοίξτε με τον Visual Studio Code",
        [_.dialogCancel]: "Ακύρωση",
        [_.dialogContinue]: "Να συνεχίσει",
        [_.dialogNeverShowAgain]: "Μην το δείξετε ξανά",
        [_.dialogOK]: "OK",
        [_.dialogOpen]: "Άνοιγμα",
        [_.docLimited]: "Περιορισμένο",
        [_.docLimitedTooltip]: "Δεν είναι διαθέσιμες όλες οι επιλογές σε αυτό το αρχείο.",
        [_.documentation]: "Τεκμηρίωση",
        ...
        [_.helpOptions]: "Επιλογές",
        [_.helpUserInterface]: "Διεπαφή χρήστη",
        [_.helpTemplates]: "Πρότυπα ημερομηνιών",
        ...
        [_.manageDatesCalendarTemplateName]: "Πρότυπο",
        ...
        [_.manageDatesManageTemplates]: "Διαχείριση προτύπων",
        ...
        [_.manageDatesTemplateNameConfig02]: "Καθιερωμένο - Δημοσιονομικός",
        [_.manageDatesTemplateNameConfig03]: "Μηνιαία",
        [_.manageDatesTemplateNameConfig04]: "Μηνιαία - Δημοσιονομικός",
        [_.manageDatesTemplateNameConfig05]: "Προσαρμογή",
        [_.manageDatesTemplateNameConfig06]: "Προσαρμογή - Δημοσιονομικός",
        [_.manageDatesTemplateNameConfig07]: "Εβδομαδιαία",
        ...
        [_.manageCalendarsTableLabel]: "Πίνακας:",
        [_.manageCalendarsAddCalendar]: "Προσθήκη ημερολογίου",
        [_.manageCalendarsTitle]: "Ημερολόγια",
        [_.manageCalendarsColumnMapping]: "Αντιστοίχιση στηλών",
        [_.manageCalendarsLoadError]: "Σφάλμα κατά τη φόρτωση ημερολογίων πίνακα",
        [_.manageCalendarsNoCalendars]: "Δεν έχουν οριστεί ημερολόγια για αυτόν τον πίνακα",
        [_.manageCalendarsDeleteButton]: "Διαγραφή",
        [_.manageCalendarsColumnName]: "Στήλη",
        [_.manageCalendarsSampleValues]: "Δείγμα τιμών",
        [_.manageCalendarsBlank]: "(κενό)",
        [_.manageCalendarsUnassigned]: "Μη αντιστοιχισμένο",
        [_.manageCalendarsDate]: "Ημερομηνία",
        [_.manageCalendarsYear]: "Έτος",
        [_.manageCalendarsSemester]: "Εξάμηνο",
        [_.manageCalendarsSemesterOfYear]: "Εξάμηνο του Έτους",
        [_.manageCalendarsQuarter]: "Τρίμηνο",
        [_.manageCalendarsQuarterOfYear]: "Τρίμηνο του Έτους",
        [_.manageCalendarsQuarterOfSemester]: "Τρίμηνο του Εξαμήνου",
        [_.manageCalendarsMonth]: "Μήνας",
        [_.manageCalendarsMonthOfYear]: "Μήνας του Έτους",
        [_.manageCalendarsMonthOfSemester]: "Μήνας του Εξαμήνου",
        [_.manageCalendarsMonthOfQuarter]: "Μήνας του Τριμήνου",
        [_.manageCalendarsWeek]: "Εβδομάδα",
        [_.manageCalendarsWeekOfYear]: "Εβδομάδα του Έτους",
        [_.manageCalendarsWeekOfSemester]: "Εβδομάδα του Εξαμήνου",
        [_.manageCalendarsWeekOfQuarter]: "Εβδομάδα του Τριμήνου",
        [_.manageCalendarsWeekOfMonth]: "Εβδομάδα του Μήνα",
        [_.manageCalendarsDayOfYear]: "Ημέρα του Έτους",
        [_.manageCalendarsDayOfSemester]: "Ημέρα του Εξαμήνου",
        [_.manageCalendarsDayOfQuarter]: "Ημέρα του Τριμήνου",
        [_.manageCalendarsDayOfMonth]: "Ημέρα του Μήνα",
        [_.manageCalendarsDayOfWeek]: "Ημέρα της Εβδομάδας",
        [_.manageCalendarsTimeRelated]: "Σχετικό με το χρόνο",
        [_.manageCalendarsUpdateSuccess]: "Το ημερολόγιο ενημερώθηκε με επιτυχία",
        [_.manageCalendarsUpdateError]: "Σφάλμα κατά την ενημέρωση του ημερολογίου",
        [_.manageCalendarsEnterName]: "Εισαγάγετε το όνομα του ημερολογίου:",
        [_.manageCalendarsCreateSuccess]: "Το ημερολόγιο δημιουργήθηκε με επιτυχία",
        [_.manageCalendarsCreateError]: "Σφάλμα κατά τη δημιουργία του ημερολογίου",
        [_.manageCalendarsConfirmDelete]: "Είστε βέβαιοι ότι θέλετε να διαγράψετε το ημερολόγιο '{0}';",
        [_.manageCalendarsDeleteSuccess]: "Το ημερολόγιο διαγράφηκε με επιτυχία",
        [_.manageCalendarsDeleteError]: "Σφάλμα κατά τη διαγραφή του ημερολογίου",
        [_.manageCalendarsRenameCalendar]: "Μετονομασία",
        [_.manageCalendarsEnterNewName]: "Εισαγάγετε το νέο όνομα του ημερολογίου:",
        [_.manageCalendarsRenameSuccess]: "Το ημερολόγιο μετονομάστηκε με επιτυχία",
        [_.manageCalendarsRenameError]: "Σφάλμα κατά τη μετονομασία του ημερολογίου",
        [_.manageCalendarsUnknown]: "Άγνωστο",
        [_.manageCalendarsDeleteCalendar]: "Διαγραφή",
        [_.manageCalendarsSmartCompletion]: "Έξυπνη συμπλήρωση",
        [_.manageCalendarsSmartCompletionTooltip]: "Αντιστοίχιση κατηγορίας ημερολογίου σε κάθε μη αντιστοιχισμένη στήλη με βάση την πληθάριθμο της στήλης Έτος. Αντιστοιχίστε το Έτος χειροκίνητα πριν ξεκινήσετε.",
        [_.manageCalendarsAcceptAllSuggestions]: "Αποδοχή όλων των προτάσεων",
        [_.manageCalendarsHideUnassignedColumns]: "Απόκρυψη μη αντιστοιχισμένων στηλών",
        [_.manageCalendarsLegendPrimary]: "Κύρια",
        [_.manageCalendarsLegendPrimaryTooltip]: "Κύρια στήλη για τη σχετική κατηγορία",
        [_.manageCalendarsLegendAssociated]: "Συσχετισμένη",
        [_.manageCalendarsLegendAssociatedTooltip]: "Συσχετισμένη στήλη για τη σχετική κατηγορία",
        [_.manageCalendarsLegendLinked]: "Συνδεδεμένη",
        [_.manageCalendarsLegendLinkedTooltip]: "Έμμεσα συσχετισμένη στήλη για τη σχετική κατηγορία επειδή χρησιμοποιείται για ταξινόμηση κύριας ή συσχετισμένης στήλης",
        [_.manageCalendarsColumnHeaderValues]: "# ΤΙΜΕΣ",
        [_.manageCalendarsPromoteTooltip]: "Κάντε κλικ για να το κάνετε την κύρια στήλη",
        [_.manageCalendarsRemoveAssignmentTooltip]: "Κάντε κλικ για να αφαιρέσετε την αντιστοίχιση",
        [_.manageCalendarsImplicitColumnTooltip]: "Έμμεσα συσχετισμένη στήλη για τη σχετική κατηγορία μέσω σχέσης SortByColumn. Κάντε κλικ για να την κάνετε την κύρια στήλη.",
        [_.manageCalendarsCardinalityWarningTooltip]: "Η πληθάριθμος {actualCardinality} δεν ταιριάζει με την αναμενόμενη τιμή {expectedCardinality} για την κατηγορία {categoryName}.",
        [_.manageCalendarsRemovePrimaryAriaLabel]: "Αφαίρεση κύριας αντιστοίχισης για {categoryName}",
        [_.manageCalendarsPromoteToPrimaryAriaLabel]: "Προβιβασμός {categoryName} σε κύρια",
        [_.manageCalendarsLinkedColumnAriaLabel]: "Συνδεδεμένη στήλη μέσω SortByColumn για {categoryName}",
        [_.manageCalendarsCardinalityWarningAriaLabel]: "Προειδοποίηση πληθάριθμου: βρέθηκε {actualCardinality}, αναμενόταν {expectedCardinality}",
        [_.manageCalendarsGridAriaLabel]: "Αντιστοιχίσεις στηλών ημερολογίου",
        [_.manageCalendarsCellAriaLabel]: "{columnName} για ημερολόγιο {calendarName}",
        [_.manageCalendarsUpdateAnnouncement]: "{columnName} ενημερώθηκε σε {categoryName}",
        ...
        [_.optionDev]: "Ενεργοποιήστε τα πρότυπα ημερομηνίας χρήστη",
        ...
        [_.optionResetAlerts]: "Επαναφορά ειδοποιήσεων",
        [_.optionResetAlertsButton]: "Επαναφέρω",
        [_.optionResetAlertsDescription]: "Επαναφέρετε όλες τις χειροκίνητα κρυμμένες ειδοποιήσεις.",
        [_.optionsDialogAboutMenu]: "Σχετικά",
        [_.optionsDialogDevMenu]: "Πρότυπα",
