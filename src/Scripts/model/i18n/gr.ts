...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.errorTemplateAlreadyExists]: "Ένα άλλο πρότυπο με το ίδιο μονοπάτι υπάρχει ήδη!",
        ...
        [_.optionDev]: "Ενεργοποιήστε τα πρότυπα προσαρμοσμένης ημερομηνίας",
        ...
        [_.optionsDialogDevMenu]: "Ανάπτυξη",
