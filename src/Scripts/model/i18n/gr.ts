...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.docObfuscated]: "Αποκρυπτογραφημένο",
        [_.docObfuscatedTooltip]: "Αυτό το έγγραφο φορτώθηκε από ένα αποκρυπτογραφημένο αρχείο VPAX. Κάντε κλικ για να το αποκρυπτογραφήσετε.",
        [_.deobfuscateDialogTitle]: "Αποκρυπτογράφηση VPAX",
        [_.deobfuscateDialogDragFile]: "Σύρετε το αρχείο λεξικού VPAX εδώ<br>ή αναζητήστε το στον υπολογιστή σας",
        [_.deobfuscateDialogNote]: "Το αρχείο λεξικού (.dict) είναι απαραίτητο για την αποκρυπτογράφηση του αρχείου VPAX. Χρησιμοποιείται αποκλειστικά για αυτόν τον σκοπό και δεν κοινοποιείται, αποθηκεύεται ή μεταδίδεται ποτέ εκτός αυτής της εφαρμογής.",
