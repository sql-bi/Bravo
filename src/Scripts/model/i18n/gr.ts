...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.optionProxyDefaultCredentials]: "Χρησιμοποιήστε τα διαπιστευτήρια του συστήματος",
        [_.optionProxyDefaultCredentialsDescription]: `Χρησιμοποιήστε τα προεπιλεγμένα διαπιστευτήρια του συστήματος για να πιστοποιήσετε τον έλεγχο του διακομιστή μεσολάβησης. <span class="hl">Αυτή η επιλογή είναι απενεργοποιημένη, τα προσαρμοσμένα διαπιστευτήρια έχουν αποθηκευτεί στον υπολογιστή σας.</span>`,
