...
#nullable disable
    ...
    internal class ExpressionParser
    {
        ...
        {
            typeof(global::TabularEditor.TOMWrapper.Utils.DaxDependencyHelper)
        };
        ...
        Stack<ParameterExpression> itStack = new();
...
#pragma warning restore 0219
        ...
        Expression ParseNew()
        {
            ...
            ValidateToken(TokenId.OpenParen, Res.OpenParenExpected);
            NextToken();
            List<DynamicLinq.DynamicProperty> properties = new List<DynamicLinq.DynamicProperty>();
            ...
            while (true)
            {
                ...
                properties.Add(new DynamicLinq.DynamicProperty(propName, expr.Type));
                if (token.id != TokenId.Comma) break;
                NextToken();
            }
            ValidateToken(TokenId.CloseParen, Res.CloseParenOrCommaExpected);
            NextToken();
            Type type = DynamicLinq.DynamicExpression.CreateClass(properties);
