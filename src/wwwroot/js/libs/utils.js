...
class Utils {
    ...
    static Request = class {
        ...
        // Send ajax call
        static async ajax(url, data = {}, options = {}) {
    ...
    static String = class {
        ...
        static measureWidth(string, font) {

            if (!Utils.String.measureCanvas)
                Utils.String.measureCanvas = document.createElement('canvas');
            
            let context = Utils.String.measureCanvas.getContext("2d");
            context.font = `${font.fontStyle || ""} ${font.fontVariant || ""} ${font.fontWeight || ""} ${font.fontSize} ${font.fontFamily}`;
            let size = context.measureText(string);
    ...
    static Number = class {
        ...
        static formatBytes(value, decimals = 2, refValue = 0) {
            ...
            let n = parseFloat(value / Math.pow(k, i)).toFixed(i ? decimals : 0);
            if (n == 0) n = `<${n}`;
        ...
        static compress(value, decimals = 2) {
    ...
    static Color = class {
        ...
        static palette(colors, count = 10) {
            let ret = [];
            let modifier = 0;
            let colorIndex = 0;
        ...
        static saturate(hex, percent, baseColor) {
         ...
         */ 
        static shade(c0, p, c1 = null, l = false) {
    ...
    static Obj = class {
        ...
        static isEmpty(object, includeNull = true) {
        ...
        // Check object type
        static is(x, what = "Object") { 
            return Object.prototype.toString.call(x) === `[object ${Utils.String.ucfirst(what)}]`;
        }
        static isObject(x) {
...
HTMLElement.prototype.toggleAttr = function(name, toggle, value = "") {
...
// Selectors helpers
function _(selector, container = document) {
...
function __(selector, container = document) {
