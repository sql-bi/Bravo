...
class Debug { 
    ...
    apiCall(action: string) {
        switch (action) {
            case "api/GetModelFromVpax":
            case "api/GetModelFromReport": 
            case "api/GetModelFromDataset":
    ...
    sampleTabularDatabase: TabularDatabase = {
        model: {
            "tablesCount": 10,
            "columnsCount": 68,
            "unreferencedCount": 5,
...
export const debug = (process.env.DEBUG ? new Debug() : null);