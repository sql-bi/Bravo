...
export enum strings {
    ...
    columnMeasureNotFormattedTooltip = "This measure is not formatted.",
    columnMeasureWithError = "This measure contains errors.",
    columnMeasureFormatted = "This measure is already formatted.",
    columnUnreferencedExplanation = `Unreferenced columns can generally be removed from the model to optimize performance. Before removing them, make sure you are not using these columns in any reports, which Bravo cannot determine.`,
    columnUnreferencedTooltip = "This column is not referenced in your model.",
    ...
    copyErrorCtrlTitle = "Copy error details",
    copyFormulaCtrlTitle = "Copy formatted measure",
    ...
    daxFormatterAutoPreviewOption = "Automatic preview",
    ...
    docReadOnlyTooltip = "This document is not editable.",
    doneCtrlTitle = "Done",
    ...
    errorPBIDesktopProcessNotFound = "Power BI Desktop process is no longer running or the report may have been be closed.",
    errorPBIDesktopSSASProcessNotFound = "Power BI Desktop instance process not found.",
    errorPBIDesktopSSASConnectionNotFound = "Power BI Desktop instance connection not found.",
    errorPBIDesktopSSASDatabaseUnexpectedCount = "Power BI Desktop instance database not found.",
    ...
    errorVpaxFileContainsCorruptedData = "The VPAX file format is not valid or contains corrupted data.",
    ...
    openWithDaxFormatterCtrlTitle = "Format online with DAX Formatter",
    ...
    refreshPreviewCtrlTitle = "Refresh preview",
