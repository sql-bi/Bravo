...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.errorVpaxFileContainsCorruptedData]: "Das VPAX-Dateiformat ist ungültig oder enthält beschädigte Daten.",
        ...
        [_.manageDatesStatusError]: `<div class="hero">Die aktuellen Einstellungen können nicht übernommen werden.</div> Fehler {error}`,
