...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.daxFormatterSummary]: `Ваш набор данных содержит {count} {{меру|меры}}: <strong>{analyzable}</strong> для анализа, <span class="text-error"><strong>{errors}</strong> с ошибками</strong></span>, <span class="text-highlight"><strong>{formattable}</strong> для формотирования.</span>`,
        [_.daxFormatterSummaryNoAnalysis]: `Ваш набор данных содержит <strong>{count}</strong> {{меру|меры}}: <span class="text-error"><strong>{errors}</strong> с ошибками</strong></span> and <span class="text-highlight"><strong>{formattable}</strong> для форматирования.</span>`,
