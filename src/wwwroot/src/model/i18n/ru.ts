...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.openSourcePayoff]: "Bravo для Power BI — это инструмент с открытым исходным кодом, разработанный и поддерживаемый SQLBI и сообществом Github. Присоединяйтесь к нам",
        ...
        [_.welcomeTitle]: "Bravo для Power BI",
