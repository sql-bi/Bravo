...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.AnalyzeModel]: "Analyser Model",
        [_.analyzeModelSummary]: `Dit datasæt fylder <strong>{size:bytes}</strong> og indeholder <strong>{count}</strong> kolonner{{s}}`,
        [_.analyzeModelSummary2]: `, <span class="text-highlight"><strong>{count}</strong> som ikke {{er|er}} refereret til i modellen.</span>`,
        ...
        [_.appUpdateViewDetails]: "Se detaljer",
        [_.appUpToDate]: "Bravo er opdateret",
        [_.appVersion]: "Version {version}",
        [_.backupReminder]: "Før du fortsætter, husk da at tage en sikkerhedskopi af din rapport - <b>nogle ændringer kan ikke fortrydes</b>.",
        ...
        [_.changeStatusModified]: "Æ",
        [_.changeStatusModifiedTitle]: "Ændret",
        [_.clearCtrlTitle]: "Ryd",
        [_.closeCtrlTitle]: "Luk",
        [_.closeOtherTabs]: "Luk andre",
        [_.closeTab]: "Luk",
//TRANSLATION MISSING FROM HERE AND DOWN
