...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.manageDatesCalendarDesc]: "Scegli un tipo di calendario da applicare al modello. Bravo creerà le tabelle necessarie o le aggiornerà se già presenti, mantenendo attive le relazioni esistenti.", 
        ...
        [_.manageDatesTemplateFirstFiscalMonthDesc]: "Imposta il primo mese dell'anno. Per calendari settimanali ISO, usa <em>Gennaio</em>.",
        [_.manageDatesTemplateFirstDayOfWeek]: "Primo Giorno della Settimana",
        [_.manageDatesTemplateFirstDayOfWeekDesc]: "Scegli il primo giorno della settimana. Per calendari settimanali ISO, usa <em>Lunedì</em>.",
        [_.manageDatesTemplateMonthsInYear]: "Mesi nell'Anno",
        [_.manageDatesTemplateMonthsInYearDesc]: "Scegli quanto è lungo un anno.",
        [_.manageDatesTemplateQuarterWeekType]: "Raggruppamento Settimane",
        [_.manageDatesTemplateQuarterWeekTypeDesc]: "Scegli come raggruppare le settimane nei trimestri.",
        [_.manageDatesTemplateWeeklyType]: "Ultimo Giorno della Settimana dell'Anno",
        [_.manageDatesTemplateWeeklyTypeDesc]: "Scegli l'ultimo giorno della settimana dell'anno. Se la tua settimana inizia Lunedì, l'ultimo giorno della settimana è Domenica. Con <em>Ultimo dell'Anno</em> l'anno fiscale finisce l'ultima Domenica dell'ultimo mese. Altrimenti, l'anno fiscale finisce la Domenica più vicina all'ultimo giorno dell'ultimo mese - potrebbe essere all'anno successivo. Per calendari settimanali ISO, usa <em>Più Vicino alla Fine dell'Anno</em>.",
