...
const locale: Locale = {
    ...
    name: "Français", //DO NOT TRANSLATE
    ...
    strings: {
        ...
        [_.daxFormatterSummary]: `Votre jeu de données contient {count} mesure{{s}}: <strong>{analyzable}</strong> à analyser, <span class="text-error"><strong>{errors}</strong> avec erreurs</strong></span>, <span class="text-highlight"><strong>{formattable}</strong> à formater.</span>`,
        [_.daxFormatterSummaryNoAnalysis]: `Votre jeu de données contient <strong>{count}</strong> mesure{{s}}: <span class="text-error"><strong>{errors}</strong> avec erreurs</strong></span> et <span class="text-highlight"><strong>{formattable}</strong> à formater.</span>`,
        ...
        [_.errorVpaxFileContainsCorruptedData]: "Le format du fichier VPAX n'est pas valide ou contient des données corrompues.",
        ...
        [_.manageDatesStatusError]: `<div class="hero">Les changements actuels ne peuvent pas être appliqués.</div> Erreur {error}`,
        ...
        [_.openSourcePayoff]: "Bravo pour Power BI est un outil open-source tool développé et maintenu par SQLBI et la communité Github. Rejoignez-nous sur",
        ...
        [_.welcomeTitle]: "Bravo pour Power BI",
