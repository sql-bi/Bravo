...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.copy]: "Copy",
        [_.copyErrorCtrlTitle]: "Copy error details",
        ...
        [_.errorPBIDesktopProcessNotFound]: "Power BI Desktop process is no longer running or the report may have been be closed.",
        [_.errorPBIDesktopSSASProcessNotFound]: "Power BI Desktop instance process not found.",
        [_.errorPBIDesktopSSASConnectionNotFound]: "Power BI Desktop instance connection not found.",
        [_.errorPBIDesktopSSASDatabaseUnexpectedCount]: "Power BI Desktop instance database not found.",
        ...
        [_.filterErrorsCtrlTitle]: "Filter measures with errors",
        [_.filterUnformattedCtrlTitle]: "Filter unformatted measures",
        [_.filterUnrefCtrlTitle]: "Filter unreferenced columns",
        ...
        [_.helpConnectVideo]: "Connect Bravo to your Data",
        ...
        [_.optionsDialogGeneralMenu]: "Options",
        [_.optionsDialogTitle]: "Options",
        [_.otherColumnsRowName]: "Smaller columns...",
        [_.previewPlaceholder]: "Select a measure to see the preview...",
        ...
        [_.settingsCtrlTitle]: "Settings",
        [_.sheetOrphan]: "Not available",
        [_.sheetOrphanPBIXTooltip]: "The related report in Power BI Desktop has been closed. Any writing operation is disallowed.",
