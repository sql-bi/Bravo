...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.manageDatesStatusOk]: `<div class="hero">This model <b>doesn't contain any date tables</b>.</div>You can use this feature without worrying about breaking measures or reports.`,
