...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.manageDatesMenuModified]: "To Add/Modify",
        [_.manageDatesMenuModifiedPlaceholder]: "No items to modify.",
        [_.manageDatesMenuRemoved]: "To Remove",
        [_.manageDatesMenuRemovedPlaceholder]: "No items to remove.",
