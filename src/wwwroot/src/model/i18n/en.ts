...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.exportDataTypeCSV]: "Comma-separated values",
        ...
        [_.manageDatesMenuInterval]: "Dates Interval",
        [_.manageDatesMenuHolidays]: "Holidays",
        [_.manageDatesMenuTimeIntelligence]: "Time Intelligence",
        [_.manageDatesMenuLocalization]: "Localization",
        [_.manageDatesPreviewCtrlTitle]: "Preview Changes",
        [_.manageDatesApplyCtrlTitle]: "Apply",
        [_.manageDatesCalendarDesc]: "Choose a calendar template to apply to this model. Bravo will create the required tables if they don't exist or update them while keeping the existing relationships intact.", 
        ...
        [_.manageDatesTemplateFirstFiscalMonthDesc]: "Set the first month of the year. For Weekly ISO, set <em>January</em>.",
        [_.manageDatesTemplateFirstDayOfWeek]: "First Day of the Week",
        [_.manageDatesTemplateFirstDayOfWeekDesc]: "Choose the first day of the week. For Weekly ISO, set <em>Monday</em>.",
        [_.manageDatesTemplateMonthsInYear]: "Months in Year",
        [_.manageDatesTemplateMonthsInYearDesc]: "Set how many months a year is.",
        [_.manageDatesTemplateQuarterWeekType]: "Weeks Grouping",
        [_.manageDatesTemplateQuarterWeekTypeDesc]: "Choose how to group weeks in quarters.",
        [_.manageDatesTemplateWeeklyType]: "Last Weekday of the Year",
        [_.manageDatesTemplateWeeklyTypeDesc]: "Choose the last weekday of the year. If your week starts on Sunday, then the last weekday is Saturday. With <em>Last of the Year</em> the fiscal year ends on the last Saturday of the last month. Otherwise, the fiscal year ends on the Saturday closest to the last day of the last month - it could be on the next year. For Weekly ISO, set <em>Closest to the Year End</em>.",
        ...
        [_.manageDatesTemplateTypeStartFiscalYearDesc]: "Choose when to start the fiscal year. For Weekly ISO, set <em>Last of the Year</em>.",
        ...
        [_.optionFormattingBreaksDescription]: "Choose how to separate the measure name and the expression. Set <em>Auto</em> to automatically determine it in each model.",
        ...
        [_.sceneUnsupportedDaxFormatterDesc]: "It is not possible to format the DAX code of VPAX files.",
        [_.sceneUnsupportedManageDatesDesc]: "Dates and Time Intelligence functions can be edited only with reports connected to a local Power BI Desktop database.",
        [_.sceneUnsupportedExportDataDesc]: "Only Power BI reports and datasets can be exported.",
        [_.sceneUnsupportedDesc]: "The feature is not available for this data source.",
        ...
        [_.showDiagnosticPane]: "Show Diagnostics",
