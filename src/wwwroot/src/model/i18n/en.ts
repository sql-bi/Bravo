...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.manageDatesStatusOk]: `<div class="hero">Your model <b>doesn't contain any date tables</b>.</div>This feature will not impact on any existing measures or reports.`,
