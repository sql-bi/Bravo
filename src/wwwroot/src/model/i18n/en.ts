...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.sceneUnsupportedManageDatesDesc]: "Dates and Time Intelligence functions can be edited only with reports connected to local Power BI Desktop database.",
        [_.sceneUnsupportedExportDataDesc]: "Only Power BI reports and datasets can be exported.",
        [_.sceneUnsupportedDesc]: "This feature is not available for this data source.",
