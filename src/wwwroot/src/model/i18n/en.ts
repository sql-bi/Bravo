...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.manageDatesAutoScan]: "Date Interval Scan",
        [_.manageDatesAutoScanActiveRelationships]: "Active Relationships",
        [_.manageDatesAutoScanDesc]: "Choose how to determine the date interval of the model. Choose <em>Automatic</em> to scan all the columns containing dates. Set <em>Choose Columns...</em> to select the columns to use. Set <em>Active Relationships</em> and <em>Inactive Relationships</em> to scan only columns with relationships.",
        [_.manageDatesAutoScanDisabled]: "Disabled",
        [_.manageDatesAutoScanFirstYear]: "First Year",
        [_.manageDatesAutoScanFirstYearDesc]: "",
        [_.manageDatesAutoScanFull]: "Automatic",
        ...
        [_.manageDatesPreviewLoading]: "Preview loading...",
        [_.manageDatesStatusCompatible]: `<div class="hero">Your model already contains some <b>date tables compatible</b> with Bravo.</div>If you change something here, these tables will be updated and their relationships will remain intact.`,
        [_.manageDatesStatusIncompatible]: `<div class="hero">Your model contains some <b>date tables that are not compatible</b> with Bravo.</div>To make any changes here, you need to choose a different name for one or more tables that will be created by this tool.<br><br>Check <b>Dates</b> and <b>Holidays</b>.`,
        [_.manageDatesStatusOk]: `<div class="hero">Your model <b>doesn't contain any date tables</b>.</div>This feature will not affect any existing measures or reports.`,
        ...
        [_.tableValidationInvalid]: "Invalid table name.",
        [_.tableValidationInvalidRenameRequired]: "This name cannot be used.",
