...
const locale: Locale = {
    ...
    strings: {
        ...
        [_.exportDataCSVDelimiterDesc]: `Choose the character to use as delimiter of each field. 'Automatic' uses the default character of your system Culture.`,
        ...
        [_.manageDatesTemplateNameConfig03]: "Fiscal",
        ...
        [_.optionDiagnosticDescription]: "Show errors and logs in a diagnostics pane. Choose 'Basic' to log only a few messages (which will be anonymized). 'Verbose' logs all messages (which will remain integral).",
