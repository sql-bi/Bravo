...
internal sealed partial class BootstrapContextFactory
{
    ...
    [LoggerMessage(EventId = 3, Level = LogLevel.Error, Message = "Policy service could not be created. Default policies will be used for this session.")]
    private static partial void LogPolicyServiceCreationFailed(ILogger logger, Exception exception);
}
