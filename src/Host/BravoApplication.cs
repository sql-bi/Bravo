...
internal sealed class BravoApplication : IDisposable
{
    ...
    public static BravoApplicationBuilder CreateBuilder(BootstrapContext bootstrap)
    {
        return new BravoApplicationBuilder(bootstrap);
    }
    ...
    internal IServiceProvider Services => _innerApplication.Services;
    ...
    public void Run()
    {
        var instance = Services.GetRequiredService<IBravoApplicationInstance>();
        ...
        try
        {
            ...
            using var window = ActivatorUtilities.CreateInstance<AppWindow>(Services);
