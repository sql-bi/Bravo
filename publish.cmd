...
.\bin\light.exe Bravo.wixobj Components.wixobj -ext WixUIExtension.dll -ext WixUtilExtension.dll -cultures:en-us -loc Bravo-en-us.wxl -out "Bravo-%arch%-en-us.msi" -sice:ICE61 -sice:ICE80 -nologo
REM .\bin\light.exe Bravo.wixobj Components.wixobj -ext WixUIExtension.dll -ext WixUtilExtension.dll -cultures:it-it -loc Bravo-it-it.wxl -out "Bravo-%arch%-it-it.msi" -sice:ICE61 -sice:ICE80 -nologo
